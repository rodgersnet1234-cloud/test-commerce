...
import com.mailvor.modules.system.service.*;
import com.mailvor.modules.system.service.dto.UserDto;
import com.mailvor.modules.system.service.dto.UserQueryCriteria;
import com.mailvor.modules.system.service.mapper.RoleMapper;
import com.mailvor.modules.system.service.mapper.SysUserMapper;
...
public class SysUserServiceImpl extends BaseServiceImpl<SysUserMapper, User> implements UserService {
    ...
    public UserDto findByName(String userName) {
        ...
        if(user == null) {
            throw new MshopException("当前用户不存在");
        }
        //用户所属岗位
        user.setJob(jobService.getById(user.getJobId()));
        //用户所属部门
    ...
    public void updateAvatar(MultipartFile multipartFile) {
        ...
        String file = aliOssService.uploadFileAvatar(multipartFile);
        assert file != null;
        userAvatar.setRealName(multipartFile.getOriginalFilename());
        userAvatar.setPath(file);
