...
public class FaceAuthKycQueryRequestMarshaller implements RequestMarshaller<FaceAuthKycQueryRequest> {
    ...
    @Override
    public Request<FaceAuthKycQueryRequest> marshall(FaceAuthKycQueryRequest request) {
        Request<FaceAuthKycQueryRequest> internalRequest = new DefaultRequest<FaceAuthKycQueryRequest>(request, serviceName);
