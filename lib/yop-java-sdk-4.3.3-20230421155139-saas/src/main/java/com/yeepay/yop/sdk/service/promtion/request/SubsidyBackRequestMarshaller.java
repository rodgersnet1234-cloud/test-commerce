...
public class SubsidyBackRequestMarshaller implements RequestMarshaller<SubsidyBackRequest> {
    private final String serviceName = "Promtion";

    private final String resourcePath = "/rest/v1.0/promtion/subsidy/back";
    ...
    @Override
    public Request<SubsidyBackRequest> marshall(SubsidyBackRequest request) {
        Request<SubsidyBackRequest> internalRequest = new DefaultRequest<SubsidyBackRequest>(request, serviceName);
        ...
        if (request.getSubsidyBackRequestId() != null) {
            internalRequest.addParameter("subsidyBackRequestId", PrimitiveMarshallerUtils.marshalling(request.getSubsidyBackRequestId(), "String"));
        }
        if (request.getSubsidyBackAmount() != null) {
            internalRequest.addParameter("subsidyBackAmount", PrimitiveMarshallerUtils.marshalling(request.getSubsidyBackAmount(), "String"));
        }
        if (request.getReturnAccountType() != null) {
            internalRequest.addParameter("returnAccountType", PrimitiveMarshallerUtils.marshalling(request.getReturnAccountType(), "String"));
        }
    ...
    private static class CacheInstanceHolder {
        public static SubsidyBackRequestMarshaller INSTANCE = new SubsidyBackRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static SubsidyBackRequestMarshaller getInstance() {
