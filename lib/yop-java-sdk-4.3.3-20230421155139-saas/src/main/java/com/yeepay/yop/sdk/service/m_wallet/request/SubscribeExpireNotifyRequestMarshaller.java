...
public class SubscribeExpireNotifyRequestMarshaller implements RequestMarshaller<SubscribeExpireNotifyRequest> {
    private final String serviceName = "MWallet";

    private final String resourcePath = "/rest/v1.0/m-wallet/subscribe-expire-notify";
    ...
    @Override
    public Request<SubscribeExpireNotifyRequest> marshall(SubscribeExpireNotifyRequest request) {
        Request<SubscribeExpireNotifyRequest> internalRequest = new DefaultRequest<SubscribeExpireNotifyRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static SubscribeExpireNotifyRequestMarshaller INSTANCE = new SubscribeExpireNotifyRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static SubscribeExpireNotifyRequestMarshaller getInstance() {
