...
public class BindcardRequestRequestMarshaller implements RequestMarshaller<BindcardRequestRequest> {
    ...
    @Override
    public Request<BindcardRequestRequest> marshall(BindcardRequestRequest request) {
        Request<BindcardRequestRequest> internalRequest = new DefaultRequest<BindcardRequestRequest>(request, serviceName);
        ...
        if (request.getIsSMS() != null) {
            internalRequest.addParameter("isSMS", PrimitiveMarshallerUtils.marshalling(request.getIsSMS(), "Boolean"));
        }
