...
public class MemberQueryRequestMarshaller implements RequestMarshaller<MemberQueryRequest> {
    private final String serviceName = "MWallet";

    private final String resourcePath = "/rest/v1.0/m-wallet/member/query";
    ...
    @Override
    public Request<MemberQueryRequest> marshall(MemberQueryRequest request) {
        Request<MemberQueryRequest> internalRequest = new DefaultRequest<MemberQueryRequest>(request, serviceName);
        ...
        if (request.getExternalUserId() != null) {
            internalRequest.addParameter("externalUserId", PrimitiveMarshallerUtils.marshalling(request.getExternalUserId(), "String"));
        }
    ...
    private static class CacheInstanceHolder {
        public static MemberQueryRequestMarshaller INSTANCE = new MemberQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static MemberQueryRequestMarshaller getInstance() {
