...
public class BindRequestMarshaller implements RequestMarshaller<BindRequest> {
    private final String serviceName = "Offline";

    private final String resourcePath = "/rest/v1.0/offline/bind";
    ...
    @Override
    public Request<BindRequest> marshall(BindRequest request) {
        Request<BindRequest> internalRequest = new DefaultRequest<BindRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static BindRequestMarshaller INSTANCE = new BindRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static BindRequestMarshaller getInstance() {
