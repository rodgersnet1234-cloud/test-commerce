...
public class RechargeOrderRequestMarshaller implements RequestMarshaller<RechargeOrderRequest> {
    ...
    @Override
    public Request<RechargeOrderRequest> marshall(RechargeOrderRequest request) {
        Request<RechargeOrderRequest> internalRequest = new DefaultRequest<RechargeOrderRequest>(request, serviceName);
