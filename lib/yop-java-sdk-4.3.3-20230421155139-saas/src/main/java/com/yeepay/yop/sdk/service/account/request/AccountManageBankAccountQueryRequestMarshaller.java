...
public class AccountManageBankAccountQueryRequestMarshaller implements RequestMarshaller<AccountManageBankAccountQueryRequest> {
    private final String serviceName = "Account";

    private final String resourcePath = "/rest/v1.0/account/account-manage/bank-account/query";
    ...
    @Override
    public Request<AccountManageBankAccountQueryRequest> marshall(AccountManageBankAccountQueryRequest request) {
        Request<AccountManageBankAccountQueryRequest> internalRequest = new DefaultRequest<AccountManageBankAccountQueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static AccountManageBankAccountQueryRequestMarshaller INSTANCE = new AccountManageBankAccountQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static AccountManageBankAccountQueryRequestMarshaller getInstance() {
