...
public class SubsidyBackQueryRequestMarshaller implements RequestMarshaller<SubsidyBackQueryRequest> {
    private final String serviceName = "Promtion";

    private final String resourcePath = "/rest/v1.0/promtion/subsidy/back/query";
    ...
    @Override
    public Request<SubsidyBackQueryRequest> marshall(SubsidyBackQueryRequest request) {
        Request<SubsidyBackQueryRequest> internalRequest = new DefaultRequest<SubsidyBackQueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static SubsidyBackQueryRequestMarshaller INSTANCE = new SubsidyBackQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static SubsidyBackQueryRequestMarshaller getInstance() {
