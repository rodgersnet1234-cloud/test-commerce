...
public class MerchantWechatauthQueryRequestMarshaller implements RequestMarshaller<MerchantWechatauthQueryRequest> {
    private final String serviceName = "Mer";

    private final String resourcePath = "/rest/v1.0/mer/merchant/wechatauth/query";
    ...
    @Override
    public Request<MerchantWechatauthQueryRequest> marshall(MerchantWechatauthQueryRequest request) {
        Request<MerchantWechatauthQueryRequest> internalRequest = new DefaultRequest<MerchantWechatauthQueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static MerchantWechatauthQueryRequestMarshaller INSTANCE = new MerchantWechatauthQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static MerchantWechatauthQueryRequestMarshaller getInstance() {
