...
public class WechatConfigQueryRequestMarshaller implements RequestMarshaller<WechatConfigQueryRequest> {
    private final String serviceName = "Aggpay";

    private final String resourcePath = "/rest/v1.0/aggpay/wechat-config/query";
    ...
    @Override
    public Request<WechatConfigQueryRequest> marshall(WechatConfigQueryRequest request) {
        Request<WechatConfigQueryRequest> internalRequest = new DefaultRequest<WechatConfigQueryRequest>(request, serviceName);
        ...
        if (request.getAppIdType() != null) {
            internalRequest.addParameter("appIdType", PrimitiveMarshallerUtils.marshalling(request.getAppIdType(), "String"));
        }
    ...
    private static class CacheInstanceHolder {
        public static WechatConfigQueryRequestMarshaller INSTANCE = new WechatConfigQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static WechatConfigQueryRequestMarshaller getInstance() {
