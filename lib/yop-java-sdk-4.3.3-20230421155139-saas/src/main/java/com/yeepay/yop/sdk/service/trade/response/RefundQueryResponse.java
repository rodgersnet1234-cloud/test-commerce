...
public class RefundQueryResponse extends BaseResponse {
    ...
    private RefundQueryQueryRefundResponseDTOResult result;

    public RefundQueryQueryRefundResponseDTOResult getResult() {
        return result;
    }

    public void setResult(RefundQueryQueryRefundResponseDTOResult result) {
        this.result = result;
    }
