...
public class TransferB2bQueryRequestMarshaller implements RequestMarshaller<TransferB2bQueryRequest> {
    private final String serviceName = "Account";

    private final String resourcePath = "/rest/v1.0/account/transfer/b2b/query";
    ...
    @Override
    public Request<TransferB2bQueryRequest> marshall(TransferB2bQueryRequest request) {
        Request<TransferB2bQueryRequest> internalRequest = new DefaultRequest<TransferB2bQueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static TransferB2bQueryRequestMarshaller INSTANCE = new TransferB2bQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static TransferB2bQueryRequestMarshaller getInstance() {
