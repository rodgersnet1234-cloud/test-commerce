...
public class WithdrawQueryRequestMarshaller implements RequestMarshaller<WithdrawQueryRequest> {
    private final String serviceName = "Account";

    private final String resourcePath = "/rest/v1.0/account/withdraw/query";
    ...
    @Override
    public Request<WithdrawQueryRequest> marshall(WithdrawQueryRequest request) {
        Request<WithdrawQueryRequest> internalRequest = new DefaultRequest<WithdrawQueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static WithdrawQueryRequestMarshaller INSTANCE = new WithdrawQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static WithdrawQueryRequestMarshaller getInstance() {
