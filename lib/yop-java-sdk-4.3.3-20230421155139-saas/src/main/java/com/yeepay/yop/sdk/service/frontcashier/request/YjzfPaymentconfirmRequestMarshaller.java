...
public class YjzfPaymentconfirmRequestMarshaller implements RequestMarshaller<YjzfPaymentconfirmRequest> {
    ...
    @Override
    public Request<YjzfPaymentconfirmRequest> marshall(YjzfPaymentconfirmRequest request) {
        Request<YjzfPaymentconfirmRequest> internalRequest = new DefaultRequest<YjzfPaymentconfirmRequest>(request, serviceName);
