...
public class AutoWithdrawRuleSetRequestMarshaller implements RequestMarshaller<AutoWithdrawRuleSetRequest> {
    ...
    public Request<AutoWithdrawRuleSetRequest> marshall(AutoWithdrawRuleSetRequest request) {
        Request<AutoWithdrawRuleSetRequest> internalRequest = new DefaultRequest<AutoWithdrawRuleSetRequest>(request, serviceName);
        ...
        if (request.getTriggerTime() != null) {
            internalRequest.addParameter("triggerTime", PrimitiveMarshallerUtils.marshalling(request.getTriggerTime(), "String"));
        }
        if (request.getRemainAmount() != null) {
            internalRequest.addParameter("remainAmount", PrimitiveMarshallerUtils.marshalling(request.getRemainAmount(), "BigDecimal"));
        }
        ...
        if (request.getNotifyAddress() != null) {
            internalRequest.addParameter("notifyAddress", PrimitiveMarshallerUtils.marshalling(request.getNotifyAddress(), "String"));
        }
