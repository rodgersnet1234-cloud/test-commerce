...
public class BankAccountQueryOpenResultRequestMarshaller implements RequestMarshaller<BankAccountQueryOpenResultRequest> {
    private final String serviceName = "MWallet";

    private final String resourcePath = "/rest/v1.0/m-wallet/bank-account/query-open-result";
    ...
    @Override
    public Request<BankAccountQueryOpenResultRequest> marshall(BankAccountQueryOpenResultRequest request) {
        Request<BankAccountQueryOpenResultRequest> internalRequest = new DefaultRequest<BankAccountQueryOpenResultRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static BankAccountQueryOpenResultRequestMarshaller INSTANCE = new BankAccountQueryOpenResultRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static BankAccountQueryOpenResultRequestMarshaller getInstance() {
