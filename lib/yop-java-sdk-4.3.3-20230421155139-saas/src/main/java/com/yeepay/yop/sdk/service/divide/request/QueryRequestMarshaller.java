...
public class QueryRequestMarshaller implements RequestMarshaller<QueryRequest> {
    ...
    @Override
    public Request<QueryRequest> marshall(QueryRequest request) {
        Request<QueryRequest> internalRequest = new DefaultRequest<QueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static QueryRequestMarshaller INSTANCE = new QueryRequestMarshaller();
