...
public class SubsidyQueryRequestMarshaller implements RequestMarshaller<SubsidyQueryRequest> {
    private final String serviceName = "Promtion";

    private final String resourcePath = "/rest/v1.0/promtion/subsidy/query";
    ...
    @Override
    public Request<SubsidyQueryRequest> marshall(SubsidyQueryRequest request) {
        Request<SubsidyQueryRequest> internalRequest = new DefaultRequest<SubsidyQueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static SubsidyQueryRequestMarshaller INSTANCE = new SubsidyQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static SubsidyQueryRequestMarshaller getInstance() {
