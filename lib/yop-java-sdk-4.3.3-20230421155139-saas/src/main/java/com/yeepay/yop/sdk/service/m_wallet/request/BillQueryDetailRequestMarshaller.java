...
public class BillQueryDetailRequestMarshaller implements RequestMarshaller<BillQueryDetailRequest> {
    private final String serviceName = "MWallet";

    private final String resourcePath = "/rest/v1.0/m-wallet/bill/query-detail";
    ...
    @Override
    public Request<BillQueryDetailRequest> marshall(BillQueryDetailRequest request) {
        Request<BillQueryDetailRequest> internalRequest = new DefaultRequest<BillQueryDetailRequest>(request, serviceName);
        ...
        if (request.getOrderType() != null) {
            internalRequest.addParameter("orderType", PrimitiveMarshallerUtils.marshalling(request.getOrderType().getValue(), "String"));
        }
        if (request.getOrderDate() != null) {
            internalRequest.addParameter("orderDate", PrimitiveMarshallerUtils.marshalling(request.getOrderDate(), "DateTime"));
        }
    ...
    private static class CacheInstanceHolder {
        public static BillQueryDetailRequestMarshaller INSTANCE = new BillQueryDetailRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static BillQueryDetailRequestMarshaller getInstance() {
