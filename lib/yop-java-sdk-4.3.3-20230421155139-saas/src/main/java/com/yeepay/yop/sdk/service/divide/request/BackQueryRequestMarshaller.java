...
public class BackQueryRequestMarshaller implements RequestMarshaller<BackQueryRequest> {
    private final String serviceName = "Divide";

    private final String resourcePath = "/rest/v1.0/divide/back/query";
    ...
    @Override
    public Request<BackQueryRequest> marshall(BackQueryRequest request) {
        Request<BackQueryRequest> internalRequest = new DefaultRequest<BackQueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static BackQueryRequestMarshaller INSTANCE = new BackQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static BackQueryRequestMarshaller getInstance() {
