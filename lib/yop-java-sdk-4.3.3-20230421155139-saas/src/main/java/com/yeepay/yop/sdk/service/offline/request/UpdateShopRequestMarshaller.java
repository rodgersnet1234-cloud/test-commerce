...
public class UpdateShopRequestMarshaller implements RequestMarshaller<UpdateShopRequest> {
    private final String serviceName = "Offline";

    private final String resourcePath = "/rest/v1.0/offline/update-shop";
    ...
    @Override
    public Request<UpdateShopRequest> marshall(UpdateShopRequest request) {
        Request<UpdateShopRequest> internalRequest = new DefaultRequest<UpdateShopRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static UpdateShopRequestMarshaller INSTANCE = new UpdateShopRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static UpdateShopRequestMarshaller getInstance() {
