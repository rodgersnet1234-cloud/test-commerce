...
public class MerchantInfoModifyRequestMarshaller implements RequestMarshaller<MerchantInfoModifyRequest> {
    ...
    public Request<MerchantInfoModifyRequest> marshall(MerchantInfoModifyRequest request) {
        Request<MerchantInfoModifyRequest> internalRequest = new DefaultRequest<MerchantInfoModifyRequest>(request, serviceName);
        ...
        if (request.getBankToken() != null) {
            internalRequest.addParameter("bankToken", PrimitiveMarshallerUtils.marshalling(request.getBankToken(), "String"));
        }
