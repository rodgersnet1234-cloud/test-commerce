...
public class AccountinfosQueryRequestMarshaller implements RequestMarshaller<AccountinfosQueryRequest> {
    private final String serviceName = "Account";

    private final String resourcePath = "/rest/v1.0/account/accountinfos/query";
    ...
    @Override
    public Request<AccountinfosQueryRequest> marshall(AccountinfosQueryRequest request) {
        Request<AccountinfosQueryRequest> internalRequest = new DefaultRequest<AccountinfosQueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static AccountinfosQueryRequestMarshaller INSTANCE = new AccountinfosQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static AccountinfosQueryRequestMarshaller getInstance() {
