...
public class AccountBookRefundRequestMarshaller implements RequestMarshaller<AccountBookRefundRequest> {
    ...
    @Override
    public Request<AccountBookRefundRequest> marshall(AccountBookRefundRequest request) {
        Request<AccountBookRefundRequest> internalRequest = new DefaultRequest<AccountBookRefundRequest>(request, serviceName);
        ...
        if (request.getMerchantRefundRequestNo() != null) {
            internalRequest.addParameter("merchantRefundRequestNo", PrimitiveMarshallerUtils.marshalling(request.getMerchantRefundRequestNo(), "String"));
        }
        if (request.getOriginalOrderNo() != null) {
            internalRequest.addParameter("originalOrderNo", PrimitiveMarshallerUtils.marshalling(request.getOriginalOrderNo(), "String"));
        }
        if (request.getRefundAmount() != null) {
            internalRequest.addParameter("refundAmount", PrimitiveMarshallerUtils.marshalling(request.getRefundAmount(), "BigDecimal"));
        }
        if (request.getBankPostscrip() != null) {
            internalRequest.addParameter("bankPostscrip", PrimitiveMarshallerUtils.marshalling(request.getBankPostscrip(), "String"));
        }
