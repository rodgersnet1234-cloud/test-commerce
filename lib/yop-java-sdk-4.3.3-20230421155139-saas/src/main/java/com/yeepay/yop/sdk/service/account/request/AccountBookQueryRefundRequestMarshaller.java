...
public class AccountBookQueryRefundRequestMarshaller implements RequestMarshaller<AccountBookQueryRefundRequest> {
    private final String serviceName = "Account";

    private final String resourcePath = "/rest/v1.0/account/account-book/query-refund";
    ...
    @Override
    public Request<AccountBookQueryRefundRequest> marshall(AccountBookQueryRefundRequest request) {
        Request<AccountBookQueryRefundRequest> internalRequest = new DefaultRequest<AccountBookQueryRefundRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static AccountBookQueryRefundRequestMarshaller INSTANCE = new AccountBookQueryRefundRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static AccountBookQueryRefundRequestMarshaller getInstance() {
