...
public class ReceiptDownloadRequestMarshaller implements RequestMarshaller<ReceiptDownloadRequest> {
    private final String serviceName = "Divide";

    private final String resourcePath = "/yos/v1.0/divide/receipt/download";
    ...
    @Override
    public Request<ReceiptDownloadRequest> marshall(ReceiptDownloadRequest request) {
        Request<ReceiptDownloadRequest> internalRequest = new DefaultRequest<ReceiptDownloadRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static ReceiptDownloadRequestMarshaller INSTANCE = new ReceiptDownloadRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static ReceiptDownloadRequestMarshaller getInstance() {
