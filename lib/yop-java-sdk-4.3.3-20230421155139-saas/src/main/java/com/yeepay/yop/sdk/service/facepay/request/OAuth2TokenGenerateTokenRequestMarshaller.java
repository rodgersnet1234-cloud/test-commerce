...
public class OAuth2TokenGenerateTokenRequestMarshaller implements RequestMarshaller<OAuth2TokenGenerateTokenRequest> {
    ...
    public Request<OAuth2TokenGenerateTokenRequest> marshall(OAuth2TokenGenerateTokenRequest request) {
        Request<OAuth2TokenGenerateTokenRequest> internalRequest = new DefaultRequest<OAuth2TokenGenerateTokenRequest>(request, serviceName);
