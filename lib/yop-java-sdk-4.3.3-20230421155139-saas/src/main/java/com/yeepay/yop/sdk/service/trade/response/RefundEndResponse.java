...
public class RefundEndResponse extends BaseResponse {
    private static final long serialVersionUID = 1L;

    private RefundEndYopEndRefundResponseDTOResult result;

    public RefundEndYopEndRefundResponseDTOResult getResult() {
        return result;
    }

    public void setResult(RefundEndYopEndRefundResponseDTOResult result) {
        this.result = result;
    }
