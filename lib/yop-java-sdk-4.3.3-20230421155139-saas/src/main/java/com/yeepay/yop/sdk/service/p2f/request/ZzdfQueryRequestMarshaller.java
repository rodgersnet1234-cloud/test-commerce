...
public class ZzdfQueryRequestMarshaller implements RequestMarshaller<ZzdfQueryRequest> {
    private final String serviceName = "P2f";

    private final String resourcePath = "/rest/v1.0/p2f/zzdf/query";
    ...
    @Override
    public Request<ZzdfQueryRequest> marshall(ZzdfQueryRequest request) {
        Request<ZzdfQueryRequest> internalRequest = new DefaultRequest<ZzdfQueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static ZzdfQueryRequestMarshaller INSTANCE = new ZzdfQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static ZzdfQueryRequestMarshaller getInstance() {
