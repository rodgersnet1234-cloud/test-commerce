...
public class RechargeRequestMarshaller implements RequestMarshaller<RechargeRequest> {
    private final String serviceName = "Account";

    private final String resourcePath = "/rest/v1.0/account/recharge";
    ...
    @Override
    public Request<RechargeRequest> marshall(RechargeRequest request) {
        Request<RechargeRequest> internalRequest = new DefaultRequest<RechargeRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static RechargeRequestMarshaller INSTANCE = new RechargeRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static RechargeRequestMarshaller getInstance() {
