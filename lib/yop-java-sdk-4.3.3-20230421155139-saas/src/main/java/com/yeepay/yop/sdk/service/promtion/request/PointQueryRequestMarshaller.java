...
public class PointQueryRequestMarshaller implements RequestMarshaller<PointQueryRequest> {
    private final String serviceName = "Promtion";

    private final String resourcePath = "/rest/v1.0/promtion/point/query";
    ...
    @Override
    public Request<PointQueryRequest> marshall(PointQueryRequest request) {
        Request<PointQueryRequest> internalRequest = new DefaultRequest<PointQueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static PointQueryRequestMarshaller INSTANCE = new PointQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static PointQueryRequestMarshaller getInstance() {
