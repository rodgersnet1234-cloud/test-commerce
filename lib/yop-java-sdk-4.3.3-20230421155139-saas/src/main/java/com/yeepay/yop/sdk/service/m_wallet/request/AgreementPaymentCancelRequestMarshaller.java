...
public class AgreementPaymentCancelRequestMarshaller implements RequestMarshaller<AgreementPaymentCancelRequest> {
    private final String serviceName = "MWallet";

    private final String resourcePath = "/rest/v1.0/m-wallet/agreement/payment-cancel";
    ...
    @Override
    public Request<AgreementPaymentCancelRequest> marshall(AgreementPaymentCancelRequest request) {
        Request<AgreementPaymentCancelRequest> internalRequest = new DefaultRequest<AgreementPaymentCancelRequest>(request, serviceName);
        ...
        if (request.getOperateReason() != null) {
            internalRequest.addParameter("operateReason", PrimitiveMarshallerUtils.marshalling(request.getOperateReason(), "String"));
        }
    ...
    private static class CacheInstanceHolder {
        public static AgreementPaymentCancelRequestMarshaller INSTANCE = new AgreementPaymentCancelRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static AgreementPaymentCancelRequestMarshaller getInstance() {
