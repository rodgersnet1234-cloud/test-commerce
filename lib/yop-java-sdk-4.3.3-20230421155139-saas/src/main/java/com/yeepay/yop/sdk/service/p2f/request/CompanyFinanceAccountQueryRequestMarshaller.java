...
public class CompanyFinanceAccountQueryRequestMarshaller implements RequestMarshaller<CompanyFinanceAccountQueryRequest> {
    private final String serviceName = "P2f";

    private final String resourcePath = "/rest/v1.0/p2f/company-finance/account/query";
    ...
    @Override
    public Request<CompanyFinanceAccountQueryRequest> marshall(CompanyFinanceAccountQueryRequest request) {
        Request<CompanyFinanceAccountQueryRequest> internalRequest = new DefaultRequest<CompanyFinanceAccountQueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static CompanyFinanceAccountQueryRequestMarshaller INSTANCE = new CompanyFinanceAccountQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static CompanyFinanceAccountQueryRequestMarshaller getInstance() {
