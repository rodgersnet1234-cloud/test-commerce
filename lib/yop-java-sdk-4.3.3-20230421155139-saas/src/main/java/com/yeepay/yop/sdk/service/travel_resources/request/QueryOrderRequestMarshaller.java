...
public class QueryOrderRequestMarshaller implements RequestMarshaller<QueryOrderRequest> {
    private final String serviceName = "TravelResources";

    private final String resourcePath = "/rest/v1.0/travel-resources/query-cinema-order";
    ...
    @Override
    public Request<QueryOrderRequest> marshall(QueryOrderRequest request) {
        Request<QueryOrderRequest> internalRequest = new DefaultRequest<QueryOrderRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static QueryOrderRequestMarshaller INSTANCE = new QueryOrderRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static QueryOrderRequestMarshaller getInstance() {
