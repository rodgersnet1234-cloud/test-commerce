...
public class GetShopRequestMarshaller implements RequestMarshaller<GetShopRequest> {
    ...
    public Request<GetShopRequest> marshall(GetShopRequest request) {
        Request<GetShopRequest> internalRequest = new DefaultRequest<GetShopRequest>(request, serviceName);
        ...
        if (request.getStatus() != null) {
            internalRequest.addParameter("status", PrimitiveMarshallerUtils.marshalling(request.getStatus(), "String"));
        }
