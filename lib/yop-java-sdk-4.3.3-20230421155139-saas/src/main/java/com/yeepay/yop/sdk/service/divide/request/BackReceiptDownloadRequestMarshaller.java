...
public class BackReceiptDownloadRequestMarshaller implements RequestMarshaller<BackReceiptDownloadRequest> {
    private final String serviceName = "Divide";

    private final String resourcePath = "/yos/v1.0/divide/back/receipt/download";
    ...
    @Override
    public Request<BackReceiptDownloadRequest> marshall(BackReceiptDownloadRequest request) {
        Request<BackReceiptDownloadRequest> internalRequest = new DefaultRequest<BackReceiptDownloadRequest>(request, serviceName);
        ...
        if (request.getDivideBackRequestId() != null) {
            internalRequest.addParameter("divideBackRequestId", PrimitiveMarshallerUtils.marshalling(request.getDivideBackRequestId(), "String"));
        }
        ...
        if (request.getLedgerNo() != null) {
            internalRequest.addParameter("ledgerNo", PrimitiveMarshallerUtils.marshalling(request.getLedgerNo(), "String"));
        }
    ...
    private static class CacheInstanceHolder {
        public static BackReceiptDownloadRequestMarshaller INSTANCE = new BackReceiptDownloadRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static BackReceiptDownloadRequestMarshaller getInstance() {
