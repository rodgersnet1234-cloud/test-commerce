...
public class AutoDeductionCreateRequestMarshaller implements RequestMarshaller<AutoDeductionCreateRequest> {
    private final String serviceName = "MWallet";

    private final String resourcePath = "/rest/v1.0/m-wallet/trade/auto-deduction/create";
    ...
    @Override
    public Request<AutoDeductionCreateRequest> marshall(AutoDeductionCreateRequest request) {
        Request<AutoDeductionCreateRequest> internalRequest = new DefaultRequest<AutoDeductionCreateRequest>(request, serviceName);
        ...
        if (request.getBindCardId() != null) {
            internalRequest.addParameter("bindCardId", PrimitiveMarshallerUtils.marshalling(request.getBindCardId(), "String"));
        }
        if (request.getPayWay() != null) {
            internalRequest.addParameter("payWay", PrimitiveMarshallerUtils.marshalling(request.getPayWay().getValue(), "String"));
        }
    ...
    private static class CacheInstanceHolder {
        public static AutoDeductionCreateRequestMarshaller INSTANCE = new AutoDeductionCreateRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static AutoDeductionCreateRequestMarshaller getInstance() {
