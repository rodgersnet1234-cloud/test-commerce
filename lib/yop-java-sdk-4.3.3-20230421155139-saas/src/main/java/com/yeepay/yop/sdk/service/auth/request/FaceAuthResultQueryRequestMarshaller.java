...
public class FaceAuthResultQueryRequestMarshaller implements RequestMarshaller<FaceAuthResultQueryRequest> {
    private final String serviceName = "Auth";

    private final String resourcePath = "/rest/v1.0/auth/face-auth-result-query";
    ...
    @Override
    public Request<FaceAuthResultQueryRequest> marshall(FaceAuthResultQueryRequest request) {
        Request<FaceAuthResultQueryRequest> internalRequest = new DefaultRequest<FaceAuthResultQueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static FaceAuthResultQueryRequestMarshaller INSTANCE = new FaceAuthResultQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static FaceAuthResultQueryRequestMarshaller getInstance() {
