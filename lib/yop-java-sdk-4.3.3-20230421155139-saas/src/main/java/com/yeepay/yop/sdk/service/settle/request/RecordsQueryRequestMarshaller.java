...
public class RecordsQueryRequestMarshaller implements RequestMarshaller<RecordsQueryRequest> {
    ...
    public Request<RecordsQueryRequest> marshall(RecordsQueryRequest request) {
        Request<RecordsQueryRequest> internalRequest = new DefaultRequest<RecordsQueryRequest>(request, serviceName);
        ...
        if (request.getSettleRequestBeginTime() != null) {
            internalRequest.addParameter("settleRequestBeginTime", PrimitiveMarshallerUtils.marshalling(request.getSettleRequestBeginTime(), "String"));
        }
        if (request.getSettleRequestEndTime() != null) {
            internalRequest.addParameter("settleRequestEndTime", PrimitiveMarshallerUtils.marshalling(request.getSettleRequestEndTime(), "String"));
        }
