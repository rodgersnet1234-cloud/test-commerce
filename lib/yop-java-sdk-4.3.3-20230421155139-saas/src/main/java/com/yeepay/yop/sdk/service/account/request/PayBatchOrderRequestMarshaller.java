...
public class PayBatchOrderRequestMarshaller implements RequestMarshaller<PayBatchOrderRequest> {
    private final String serviceName = "Account";

    private final String resourcePath = "/rest/v1.0/account/pay/batch-order";
    ...
    @Override
    public Request<PayBatchOrderRequest> marshall(PayBatchOrderRequest request) {
        Request<PayBatchOrderRequest> internalRequest = new DefaultRequest<PayBatchOrderRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static PayBatchOrderRequestMarshaller INSTANCE = new PayBatchOrderRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static PayBatchOrderRequestMarshaller getInstance() {
