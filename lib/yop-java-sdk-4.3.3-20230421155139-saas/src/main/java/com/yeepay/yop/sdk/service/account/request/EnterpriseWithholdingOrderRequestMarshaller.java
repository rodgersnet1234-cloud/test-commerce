...
public class EnterpriseWithholdingOrderRequestMarshaller implements RequestMarshaller<EnterpriseWithholdingOrderRequest> {
    ...
    @Override
    public Request<EnterpriseWithholdingOrderRequest> marshall(EnterpriseWithholdingOrderRequest request) {
        Request<EnterpriseWithholdingOrderRequest> internalRequest = new DefaultRequest<EnterpriseWithholdingOrderRequest>(request, serviceName);
