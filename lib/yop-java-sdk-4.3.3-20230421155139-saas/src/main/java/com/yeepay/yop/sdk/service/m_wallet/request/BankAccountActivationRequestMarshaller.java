...
public class BankAccountActivationRequestMarshaller implements RequestMarshaller<BankAccountActivationRequest> {
    private final String serviceName = "MWallet";

    private final String resourcePath = "/rest/v1.0/m-wallet/bank-account/activation";
    ...
    @Override
    public Request<BankAccountActivationRequest> marshall(BankAccountActivationRequest request) {
        Request<BankAccountActivationRequest> internalRequest = new DefaultRequest<BankAccountActivationRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static BankAccountActivationRequestMarshaller INSTANCE = new BankAccountActivationRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static BankAccountActivationRequestMarshaller getInstance() {
