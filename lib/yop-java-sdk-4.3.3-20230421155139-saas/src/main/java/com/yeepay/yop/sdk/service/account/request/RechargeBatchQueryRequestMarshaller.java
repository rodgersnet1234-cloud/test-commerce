...
public class RechargeBatchQueryRequestMarshaller implements RequestMarshaller<RechargeBatchQueryRequest> {
    private final String serviceName = "Account";

    private final String resourcePath = "/rest/v1.0/account/recharge/batch-query";
    ...
    @Override
    public Request<RechargeBatchQueryRequest> marshall(RechargeBatchQueryRequest request) {
        Request<RechargeBatchQueryRequest> internalRequest = new DefaultRequest<RechargeBatchQueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static RechargeBatchQueryRequestMarshaller INSTANCE = new RechargeBatchQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static RechargeBatchQueryRequestMarshaller getInstance() {
