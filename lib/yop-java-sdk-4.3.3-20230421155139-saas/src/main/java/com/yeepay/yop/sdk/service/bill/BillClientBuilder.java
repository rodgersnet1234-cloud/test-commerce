...
public class BillClientBuilder extends AbstractServiceClientBuilder<BillClientBuilder, BillClientImpl>{

    private static final AuthorizationReqRegistry REGISTRY;

    static {
        REGISTRY = new DefaultAuthorizationReqRegistry();
        REGISTRY.register("download", "YOP-SM2-SM3,YOP-RSA2048-SHA256");
    }
    ...
    @Override
    protected BillClientImpl build(ClientParams params) {
        return new BillClientImpl(params);
    }

    /**
     * @return Create new instance of builder with all defaults set.
     */
    public static BillClientBuilder builder(){
        return new BillClientBuilder();
    }
