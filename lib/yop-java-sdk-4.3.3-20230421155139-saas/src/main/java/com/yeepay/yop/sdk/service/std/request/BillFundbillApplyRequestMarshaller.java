...
public class BillFundbillApplyRequestMarshaller implements RequestMarshaller<BillFundbillApplyRequest> {
    ...
    @Override
    public Request<BillFundbillApplyRequest> marshall(BillFundbillApplyRequest request) {
        Request<BillFundbillApplyRequest> internalRequest = new DefaultRequest<BillFundbillApplyRequest>(request, serviceName);
        ...
        if (request.getBillFormat() != null) {
            internalRequest.addParameter("billFormat", PrimitiveMarshallerUtils.marshalling(request.getBillFormat(), "String"));
        }
    ...
    private static class CacheInstanceHolder {
        public static BillFundbillApplyRequestMarshaller INSTANCE = new BillFundbillApplyRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static BillFundbillApplyRequestMarshaller getInstance() {
