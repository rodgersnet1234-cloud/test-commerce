...
public class RefundEndRequestMarshaller implements RequestMarshaller<RefundEndRequest> {
    private final String serviceName = "Trade";

    private final String resourcePath = "/rest/v1.0/trade/refund/end";
    ...
    @Override
    public Request<RefundEndRequest> marshall(RefundEndRequest request) {
        Request<RefundEndRequest> internalRequest = new DefaultRequest<RefundEndRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static RefundEndRequestMarshaller INSTANCE = new RefundEndRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static RefundEndRequestMarshaller getInstance() {
