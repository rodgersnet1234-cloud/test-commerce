...
public class OrderQueryResponse extends BaseResponse {
    ...
    private OrderQueryYopQueryOrderResDTOResult result;

    public OrderQueryYopQueryOrderResDTOResult getResult() {
        return result;
    }

    public void setResult(OrderQueryYopQueryOrderResDTOResult result) {
        this.result = result;
    }
