...
public class OrderCombineQueryRequestMarshaller implements RequestMarshaller<OrderCombineQueryRequest> {
    private final String serviceName = "Trade";

    private final String resourcePath = "/rest/v1.0/trade/order/combine-query";
    ...
    @Override
    public Request<OrderCombineQueryRequest> marshall(OrderCombineQueryRequest request) {
        Request<OrderCombineQueryRequest> internalRequest = new DefaultRequest<OrderCombineQueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static OrderCombineQueryRequestMarshaller INSTANCE = new OrderCombineQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static OrderCombineQueryRequestMarshaller getInstance() {
