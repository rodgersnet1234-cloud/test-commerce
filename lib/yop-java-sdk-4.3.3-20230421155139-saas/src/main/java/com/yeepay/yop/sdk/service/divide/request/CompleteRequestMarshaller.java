...
public class CompleteRequestMarshaller implements RequestMarshaller<CompleteRequest> {
    private final String serviceName = "Divide";

    private final String resourcePath = "/rest/v1.0/divide/complete";
    ...
    @Override
    public Request<CompleteRequest> marshall(CompleteRequest request) {
        Request<CompleteRequest> internalRequest = new DefaultRequest<CompleteRequest>(request, serviceName);
        ...
        if (request.getDivideDetailDesc() != null) {
            internalRequest.addParameter("divideDetailDesc", PrimitiveMarshallerUtils.marshalling(request.getDivideDetailDesc(), "String"));
        }
    ...
    private static class CacheInstanceHolder {
        public static CompleteRequestMarshaller INSTANCE = new CompleteRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static CompleteRequestMarshaller getInstance() {
