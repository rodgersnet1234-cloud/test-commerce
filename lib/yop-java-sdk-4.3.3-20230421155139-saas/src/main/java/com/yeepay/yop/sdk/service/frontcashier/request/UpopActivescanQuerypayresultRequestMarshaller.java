...
public class UpopActivescanQuerypayresultRequestMarshaller implements RequestMarshaller<UpopActivescanQuerypayresultRequest> {
    private final String serviceName = "Frontcashier";

    private final String resourcePath = "/rest/v1.0/frontcashier/upop/activescan/querypayresult";
    ...
    @Override
    public Request<UpopActivescanQuerypayresultRequest> marshall(UpopActivescanQuerypayresultRequest request) {
        Request<UpopActivescanQuerypayresultRequest> internalRequest = new DefaultRequest<UpopActivescanQuerypayresultRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static UpopActivescanQuerypayresultRequestMarshaller INSTANCE = new UpopActivescanQuerypayresultRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static UpopActivescanQuerypayresultRequestMarshaller getInstance() {
