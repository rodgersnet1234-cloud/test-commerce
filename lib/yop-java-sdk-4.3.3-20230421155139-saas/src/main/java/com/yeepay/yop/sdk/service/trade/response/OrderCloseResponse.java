...
public class OrderCloseResponse extends BaseResponse {
    ...
    private OrderCloseResponseOrderCloseDTOResult result;

    public OrderCloseResponseOrderCloseDTOResult getResult() {
        return result;
    }

    public void setResult(OrderCloseResponseOrderCloseDTOResult result) {
        this.result = result;
    }
