...
public class SupplierApplyRequestMarshaller implements RequestMarshaller<SupplierApplyRequest> {
    private final String serviceName = "Account";

    private final String resourcePath = "/rest/v1.0/account/supplier/apply";
    ...
    @Override
    public Request<SupplierApplyRequest> marshall(SupplierApplyRequest request) {
        Request<SupplierApplyRequest> internalRequest = new DefaultRequest<SupplierApplyRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static SupplierApplyRequestMarshaller INSTANCE = new SupplierApplyRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static SupplierApplyRequestMarshaller getInstance() {
