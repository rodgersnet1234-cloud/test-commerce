...
public class SupplierPayOrderRequestMarshaller implements RequestMarshaller<SupplierPayOrderRequest> {
    ...
    @Override
    public Request<SupplierPayOrderRequest> marshall(SupplierPayOrderRequest request) {
        Request<SupplierPayOrderRequest> internalRequest = new DefaultRequest<SupplierPayOrderRequest>(request, serviceName);
        ...
        if (request.getSupplierId() != null) {
            internalRequest.addParameter("supplierId", PrimitiveMarshallerUtils.marshalling(request.getSupplierId(), "Long"));
        }
