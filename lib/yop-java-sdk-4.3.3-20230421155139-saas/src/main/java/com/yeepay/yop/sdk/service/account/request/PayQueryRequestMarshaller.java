...
public class PayQueryRequestMarshaller implements RequestMarshaller<PayQueryRequest> {
    private final String serviceName = "Account";

    private final String resourcePath = "/rest/v1.0/account/pay/query";
    ...
    @Override
    public Request<PayQueryRequest> marshall(PayQueryRequest request) {
        Request<PayQueryRequest> internalRequest = new DefaultRequest<PayQueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static PayQueryRequestMarshaller INSTANCE = new PayQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static PayQueryRequestMarshaller getInstance() {
