...
public class OrderCloseRequestMarshaller implements RequestMarshaller<OrderCloseRequest> {
    private final String serviceName = "Trade";

    private final String resourcePath = "/rest/v1.0/trade/order/close";
    ...
    @Override
    public Request<OrderCloseRequest> marshall(OrderCloseRequest request) {
        Request<OrderCloseRequest> internalRequest = new DefaultRequest<OrderCloseRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static OrderCloseRequestMarshaller INSTANCE = new OrderCloseRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static OrderCloseRequestMarshaller getInstance() {
