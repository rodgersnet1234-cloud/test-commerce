...
public class InstallmentQuerybankcfgRequestMarshaller implements RequestMarshaller<InstallmentQuerybankcfgRequest> {
    private final String serviceName = "Cnppay";

    private final String resourcePath = "/rest/v1.0/cnppay/installment/querybankcfg";
    ...
    @Override
    public Request<InstallmentQuerybankcfgRequest> marshall(InstallmentQuerybankcfgRequest request) {
        Request<InstallmentQuerybankcfgRequest> internalRequest = new DefaultRequest<InstallmentQuerybankcfgRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static InstallmentQuerybankcfgRequestMarshaller INSTANCE = new InstallmentQuerybankcfgRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static InstallmentQuerybankcfgRequestMarshaller getInstance() {
