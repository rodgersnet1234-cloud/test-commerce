...
public class WechatConfigAddV2RequestMarshaller implements RequestMarshaller<WechatConfigAddV2Request> {
    ...
    @Override
    public Request<WechatConfigAddV2Request> marshall(WechatConfigAddV2Request request) {
        Request<WechatConfigAddV2Request> internalRequest = new DefaultRequest<WechatConfigAddV2Request>(request, serviceName);
        ...
        if (request.getTradeAuthDirList() != null) {
            internalRequest.addParameter("tradeAuthDirList", PrimitiveMarshallerUtils.marshalling(request.getTradeAuthDirList(), "String"));
        }
        if (request.getAppIdList() != null) {
            internalRequest.addParameter("appIdList", PrimitiveMarshallerUtils.marshalling(request.getAppIdList(), "String"));
        }
    ...
    private static class CacheInstanceHolder {
        public static WechatConfigAddV2RequestMarshaller INSTANCE = new WechatConfigAddV2RequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static WechatConfigAddV2RequestMarshaller getInstance() {
