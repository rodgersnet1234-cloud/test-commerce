...
public class ApplyResponse extends BaseResponse {
    ...
    private ApplyYopOrderDivideResDTOResult result;

    public ApplyYopOrderDivideResDTOResult getResult() {
        return result;
    }

    public void setResult(ApplyYopOrderDivideResDTOResult result) {
        this.result = result;
    }
