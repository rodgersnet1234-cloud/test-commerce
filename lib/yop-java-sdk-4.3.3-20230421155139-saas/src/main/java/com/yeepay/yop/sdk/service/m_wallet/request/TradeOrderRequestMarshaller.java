...
public class TradeOrderRequestMarshaller implements RequestMarshaller<TradeOrderRequest> {
    ...
    private final String resourcePath = "/rest/v1.0/m-wallet/trade/order";
    ...
    public Request<TradeOrderRequest> marshall(TradeOrderRequest request) {
        Request<TradeOrderRequest> internalRequest = new DefaultRequest<TradeOrderRequest>(request, serviceName);
        ...
        if (request.getPayAmount() != null) {
            internalRequest.addParameter("payAmount", PrimitiveMarshallerUtils.marshalling(request.getPayAmount(), "String"));
        }
