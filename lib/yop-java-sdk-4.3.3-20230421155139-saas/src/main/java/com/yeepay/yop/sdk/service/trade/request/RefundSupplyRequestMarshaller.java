...
public class RefundSupplyRequestMarshaller implements RequestMarshaller<RefundSupplyRequest> {
    ...
    public Request<RefundSupplyRequest> marshall(RefundSupplyRequest request) {
        Request<RefundSupplyRequest> internalRequest = new DefaultRequest<RefundSupplyRequest>(request, serviceName);
