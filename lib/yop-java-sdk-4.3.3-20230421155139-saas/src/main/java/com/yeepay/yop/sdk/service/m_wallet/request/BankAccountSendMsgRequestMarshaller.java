...
public class BankAccountSendMsgRequestMarshaller implements RequestMarshaller<BankAccountSendMsgRequest> {
    private final String serviceName = "MWallet";

    private final String resourcePath = "/rest/v1.0/m-wallet/bank-account/send-msg";
    ...
    @Override
    public Request<BankAccountSendMsgRequest> marshall(BankAccountSendMsgRequest request) {
        Request<BankAccountSendMsgRequest> internalRequest = new DefaultRequest<BankAccountSendMsgRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static BankAccountSendMsgRequestMarshaller INSTANCE = new BankAccountSendMsgRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static BankAccountSendMsgRequestMarshaller getInstance() {
