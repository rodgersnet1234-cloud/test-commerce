...
public class BillQueryListRequestMarshaller implements RequestMarshaller<BillQueryListRequest> {
    ...
    public Request<BillQueryListRequest> marshall(BillQueryListRequest request) {
        Request<BillQueryListRequest> internalRequest = new DefaultRequest<BillQueryListRequest>(request, serviceName);
        ...
        if (request.getPageNum() != null) {
            internalRequest.addParameter("pageNum", PrimitiveMarshallerUtils.marshalling(request.getPageNum(), "Integer"));
        }
        if (request.getEndTime() != null) {
            internalRequest.addParameter("endTime", PrimitiveMarshallerUtils.marshalling(request.getEndTime(), "DateTime"));
        }
