...
public class TradeClientImpl implements TradeClient {
    ...
    public RefundEndResponse refundEnd(RefundEndRequest request) throws YopClientException{
        ...
        RequestMarshaller<RefundEndRequest> requestMarshaller = RefundEndRequestMarshaller.getInstance();
        HttpResponseHandler<RefundEndResponse> responseHandler =
                new DefaultHttpResponseHandler<RefundEndResponse>(RefundEndResponse.class,
                        HttpResponseAnalyzerSupport.getAnalyzerChain());

        return clientHandler.execute(new ClientExecutionParams<RefundEndRequest, RefundEndResponse>()
                .withInput(request)
                .withRequestMarshaller(requestMarshaller)
                .withResponseHandler(responseHandler));
    }
    ...
    public RefundFastResponse refundFast(RefundFastRequest request) throws YopClientException{
        ...
        RequestMarshaller<RefundFastRequest> requestMarshaller = RefundFastRequestMarshaller.getInstance();
        HttpResponseHandler<RefundFastResponse> responseHandler =
                new DefaultHttpResponseHandler<RefundFastResponse>(RefundFastResponse.class,
                        HttpResponseAnalyzerSupport.getAnalyzerChain());

        return clientHandler.execute(new ClientExecutionParams<RefundFastRequest, RefundFastResponse>()
                .withInput(request)
                .withRequestMarshaller(requestMarshaller)
                .withResponseHandler(responseHandler));
    }
    ...
    public RefundReceiptDownloadResponse refundReceiptDownload(RefundReceiptDownloadRequest request) throws YopClientException{
        ...
        RequestMarshaller<RefundReceiptDownloadRequest> requestMarshaller = RefundReceiptDownloadRequestMarshaller.getInstance();
        HttpResponseHandler<RefundReceiptDownloadResponse> responseHandler =
                new DefaultHttpResponseHandler<RefundReceiptDownloadResponse>(RefundReceiptDownloadResponse.class,
                        HttpResponseAnalyzerSupport.getAnalyzerChain());

        return clientHandler.execute(new ClientExecutionParams<RefundReceiptDownloadRequest, RefundReceiptDownloadResponse>()
                .withInput(request)
                .withRequestMarshaller(requestMarshaller)
                .withResponseHandler(responseHandler));
    }
    ...
    public RefundSupplyResponse refundSupply(RefundSupplyRequest request) throws YopClientException{
        ...
        RequestMarshaller<RefundSupplyRequest> requestMarshaller = RefundSupplyRequestMarshaller.getInstance();
        HttpResponseHandler<RefundSupplyResponse> responseHandler =
                new DefaultHttpResponseHandler<RefundSupplyResponse>(RefundSupplyResponse.class,
                        HttpResponseAnalyzerSupport.getAnalyzerChain());

        return clientHandler.execute(new ClientExecutionParams<RefundSupplyRequest, RefundSupplyResponse>()
                .withInput(request)
                .withRequestMarshaller(requestMarshaller)
                .withResponseHandler(responseHandler));
    }
