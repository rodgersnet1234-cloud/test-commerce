...
public class TransferSystemQueryRequestMarshaller implements RequestMarshaller<TransferSystemQueryRequest> {
    private final String serviceName = "Account";

    private final String resourcePath = "/rest/v1.0/account/transfer/system/query";
    ...
    @Override
    public Request<TransferSystemQueryRequest> marshall(TransferSystemQueryRequest request) {
        Request<TransferSystemQueryRequest> internalRequest = new DefaultRequest<TransferSystemQueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static TransferSystemQueryRequestMarshaller INSTANCE = new TransferSystemQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static TransferSystemQueryRequestMarshaller getInstance() {
