...
public class ViolationWechatChannelRequestMarshaller implements RequestMarshaller<ViolationWechatChannelRequest> {
    private final String serviceName = "Aggpay";

    private final String resourcePath = "/rest/v1.0/aggpay/violation/wechat/channel";
    ...
    @Override
    public Request<ViolationWechatChannelRequest> marshall(ViolationWechatChannelRequest request) {
        Request<ViolationWechatChannelRequest> internalRequest = new DefaultRequest<ViolationWechatChannelRequest>(request, serviceName);
        ...
        if (request.getBeginTime() != null) {
            internalRequest.addParameter("beginTime", PrimitiveMarshallerUtils.marshalling(request.getBeginTime(), "String"));
        }
    ...
    private static class CacheInstanceHolder {
        public static ViolationWechatChannelRequestMarshaller INSTANCE = new ViolationWechatChannelRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static ViolationWechatChannelRequestMarshaller getInstance() {
