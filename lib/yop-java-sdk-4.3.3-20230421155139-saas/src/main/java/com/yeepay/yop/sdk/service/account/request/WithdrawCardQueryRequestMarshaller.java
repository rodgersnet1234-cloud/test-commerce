...
public class WithdrawCardQueryRequestMarshaller implements RequestMarshaller<WithdrawCardQueryRequest> {
    private final String serviceName = "Account";

    private final String resourcePath = "/rest/v1.0/account/withdraw/card/query";
    ...
    @Override
    public Request<WithdrawCardQueryRequest> marshall(WithdrawCardQueryRequest request) {
        Request<WithdrawCardQueryRequest> internalRequest = new DefaultRequest<WithdrawCardQueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static WithdrawCardQueryRequestMarshaller INSTANCE = new WithdrawCardQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static WithdrawCardQueryRequestMarshaller getInstance() {
