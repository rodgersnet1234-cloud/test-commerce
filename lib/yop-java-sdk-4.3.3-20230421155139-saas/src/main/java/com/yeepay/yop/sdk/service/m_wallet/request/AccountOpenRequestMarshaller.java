...
public class AccountOpenRequestMarshaller implements RequestMarshaller<AccountOpenRequest> {
    private final String serviceName = "MWallet";

    private final String resourcePath = "/rest/v1.0/m-wallet/account/open";
    ...
    @Override
    public Request<AccountOpenRequest> marshall(AccountOpenRequest request) {
        Request<AccountOpenRequest> internalRequest = new DefaultRequest<AccountOpenRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static AccountOpenRequestMarshaller INSTANCE = new AccountOpenRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static AccountOpenRequestMarshaller getInstance() {
