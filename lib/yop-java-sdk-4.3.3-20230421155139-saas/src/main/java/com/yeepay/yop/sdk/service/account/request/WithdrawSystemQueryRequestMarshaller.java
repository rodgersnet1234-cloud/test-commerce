...
public class WithdrawSystemQueryRequestMarshaller implements RequestMarshaller<WithdrawSystemQueryRequest> {
    private final String serviceName = "Account";

    private final String resourcePath = "/rest/v1.0/account/withdraw/system/query";
    ...
    @Override
    public Request<WithdrawSystemQueryRequest> marshall(WithdrawSystemQueryRequest request) {
        Request<WithdrawSystemQueryRequest> internalRequest = new DefaultRequest<WithdrawSystemQueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static WithdrawSystemQueryRequestMarshaller INSTANCE = new WithdrawSystemQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static WithdrawSystemQueryRequestMarshaller getInstance() {
