...
public class BillFundbillFlowSumRequestMarshaller implements RequestMarshaller<BillFundbillFlowSumRequest> {
    private final String serviceName = "Std";

    private final String resourcePath = "/rest/v1.0/std/bill/fundbill/flow/sum";
    ...
    @Override
    public Request<BillFundbillFlowSumRequest> marshall(BillFundbillFlowSumRequest request) {
        Request<BillFundbillFlowSumRequest> internalRequest = new DefaultRequest<BillFundbillFlowSumRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static BillFundbillFlowSumRequestMarshaller INSTANCE = new BillFundbillFlowSumRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static BillFundbillFlowSumRequestMarshaller getInstance() {
