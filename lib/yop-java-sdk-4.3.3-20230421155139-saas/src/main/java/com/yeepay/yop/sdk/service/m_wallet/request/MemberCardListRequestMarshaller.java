...
public class MemberCardListRequestMarshaller implements RequestMarshaller<MemberCardListRequest> {
    private final String serviceName = "MWallet";

    private final String resourcePath = "/rest/v1.0/m-wallet/member/card-list";
    ...
    @Override
    public Request<MemberCardListRequest> marshall(MemberCardListRequest request) {
        Request<MemberCardListRequest> internalRequest = new DefaultRequest<MemberCardListRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static MemberCardListRequestMarshaller INSTANCE = new MemberCardListRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static MemberCardListRequestMarshaller getInstance() {
