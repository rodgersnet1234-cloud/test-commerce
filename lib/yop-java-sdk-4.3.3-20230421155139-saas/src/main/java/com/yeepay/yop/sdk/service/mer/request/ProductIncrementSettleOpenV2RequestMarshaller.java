...
public class ProductIncrementSettleOpenV2RequestMarshaller implements RequestMarshaller<ProductIncrementSettleOpenV2Request> {
    private final String serviceName = "Mer";

    private final String resourcePath = "/rest/v2.0/mer/product/increment-settle/open";
    ...
    @Override
    public Request<ProductIncrementSettleOpenV2Request> marshall(ProductIncrementSettleOpenV2Request request) {
        Request<ProductIncrementSettleOpenV2Request> internalRequest = new DefaultRequest<ProductIncrementSettleOpenV2Request>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static ProductIncrementSettleOpenV2RequestMarshaller INSTANCE = new ProductIncrementSettleOpenV2RequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static ProductIncrementSettleOpenV2RequestMarshaller getInstance() {
