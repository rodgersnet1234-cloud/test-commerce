...
public class TransferB2cQueryRequestMarshaller implements RequestMarshaller<TransferB2cQueryRequest> {
    ...
    public Request<TransferB2cQueryRequest> marshall(TransferB2cQueryRequest request) {
        Request<TransferB2cQueryRequest> internalRequest = new DefaultRequest<TransferB2cQueryRequest>(request, serviceName);
