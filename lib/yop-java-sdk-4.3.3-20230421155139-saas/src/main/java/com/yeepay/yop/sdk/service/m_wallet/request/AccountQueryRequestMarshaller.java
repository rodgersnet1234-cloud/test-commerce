...
public class AccountQueryRequestMarshaller implements RequestMarshaller<AccountQueryRequest> {
    private final String serviceName = "MWallet";

    private final String resourcePath = "/rest/v1.0/m-wallet/account/query";
    ...
    @Override
    public Request<AccountQueryRequest> marshall(AccountQueryRequest request) {
        Request<AccountQueryRequest> internalRequest = new DefaultRequest<AccountQueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static AccountQueryRequestMarshaller INSTANCE = new AccountQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static AccountQueryRequestMarshaller getInstance() {
