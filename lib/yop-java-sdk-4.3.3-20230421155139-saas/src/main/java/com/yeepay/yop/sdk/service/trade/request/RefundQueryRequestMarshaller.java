...
public class RefundQueryRequestMarshaller implements RequestMarshaller<RefundQueryRequest> {
    private final String serviceName = "Trade";

    private final String resourcePath = "/rest/v1.0/trade/refund/query";
    ...
    @Override
    public Request<RefundQueryRequest> marshall(RefundQueryRequest request) {
        Request<RefundQueryRequest> internalRequest = new DefaultRequest<RefundQueryRequest>(request, serviceName);
        ...
        if (request.getUniqueRefundNo() != null) {
            internalRequest.addParameter("uniqueRefundNo", PrimitiveMarshallerUtils.marshalling(request.getUniqueRefundNo(), "String"));
        }
    ...
    private static class CacheInstanceHolder {
        public static RefundQueryRequestMarshaller INSTANCE = new RefundQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static RefundQueryRequestMarshaller getInstance() {
