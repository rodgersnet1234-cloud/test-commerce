...
public class WithdrawOrderRequestMarshaller implements RequestMarshaller<WithdrawOrderRequest> {
    ...
    public Request<WithdrawOrderRequest> marshall(WithdrawOrderRequest request) {
        Request<WithdrawOrderRequest> internalRequest = new DefaultRequest<WithdrawOrderRequest>(request, serviceName);
        ...
        if (request.getBankCardId() != null) {
            internalRequest.addParameter("bankCardId", PrimitiveMarshallerUtils.marshalling(request.getBankCardId(), "String"));
        }
        ...
        if (request.getFeeDeductType() != null) {
            internalRequest.addParameter("feeDeductType", PrimitiveMarshallerUtils.marshalling(request.getFeeDeductType(), "String"));
        }
