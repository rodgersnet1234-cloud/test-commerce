...
public class FeeQueryRequestMarshaller implements RequestMarshaller<FeeQueryRequest> {
    private final String serviceName = "Invoice";

    private final String resourcePath = "/rest/v1.0/invoice/fee/query";
    ...
    @Override
    public Request<FeeQueryRequest> marshall(FeeQueryRequest request) {
        Request<FeeQueryRequest> internalRequest = new DefaultRequest<FeeQueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static FeeQueryRequestMarshaller INSTANCE = new FeeQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static FeeQueryRequestMarshaller getInstance() {
