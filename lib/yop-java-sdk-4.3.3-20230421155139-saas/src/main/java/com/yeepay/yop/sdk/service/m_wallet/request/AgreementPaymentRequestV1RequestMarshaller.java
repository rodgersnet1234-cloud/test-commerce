...
public class AgreementPaymentRequestV1RequestMarshaller implements RequestMarshaller<AgreementPaymentRequestV1Request> {
    private final String serviceName = "MWallet";

    private final String resourcePath = "/rest/v1.0/m-wallet/agreement/payment-request";
    ...
    @Override
    public Request<AgreementPaymentRequestV1Request> marshall(AgreementPaymentRequestV1Request request) {
        Request<AgreementPaymentRequestV1Request> internalRequest = new DefaultRequest<AgreementPaymentRequestV1Request>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static AgreementPaymentRequestV1RequestMarshaller INSTANCE = new AgreementPaymentRequestV1RequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static AgreementPaymentRequestV1RequestMarshaller getInstance() {
