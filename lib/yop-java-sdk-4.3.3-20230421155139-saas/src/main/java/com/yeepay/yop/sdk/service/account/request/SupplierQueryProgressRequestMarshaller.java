...
public class SupplierQueryProgressRequestMarshaller implements RequestMarshaller<SupplierQueryProgressRequest> {
    private final String serviceName = "Account";

    private final String resourcePath = "/rest/v1.0/account/supplier/query-progress";
    ...
    @Override
    public Request<SupplierQueryProgressRequest> marshall(SupplierQueryProgressRequest request) {
        Request<SupplierQueryProgressRequest> internalRequest = new DefaultRequest<SupplierQueryProgressRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static SupplierQueryProgressRequestMarshaller INSTANCE = new SupplierQueryProgressRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static SupplierQueryProgressRequestMarshaller getInstance() {
