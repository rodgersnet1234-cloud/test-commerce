...
public class BankAccountOpenRequestMarshaller implements RequestMarshaller<BankAccountOpenRequest> {
    private final String serviceName = "MWallet";

    private final String resourcePath = "/rest/v1.0/m-wallet/bank-account/open";
    ...
    public Request<BankAccountOpenRequest> marshall(BankAccountOpenRequest request) {
        Request<BankAccountOpenRequest> internalRequest = new DefaultRequest<BankAccountOpenRequest>(request, serviceName);
