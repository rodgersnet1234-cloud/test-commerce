...
public class SettleWayQueryRequestMarshaller implements RequestMarshaller<SettleWayQueryRequest> {
    private final String serviceName = "Settle";

    private final String resourcePath = "/rest/v1.0/settle/settle-way/query";
    ...
    @Override
    public Request<SettleWayQueryRequest> marshall(SettleWayQueryRequest request) {
        Request<SettleWayQueryRequest> internalRequest = new DefaultRequest<SettleWayQueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static SettleWayQueryRequestMarshaller INSTANCE = new SettleWayQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static SettleWayQueryRequestMarshaller getInstance() {
