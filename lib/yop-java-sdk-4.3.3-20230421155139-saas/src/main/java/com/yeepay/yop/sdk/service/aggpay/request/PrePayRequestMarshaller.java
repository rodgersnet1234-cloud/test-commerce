...
public class PrePayRequestMarshaller implements RequestMarshaller<PrePayRequest> {
    ...
    @Override
    public Request<PrePayRequest> marshall(PrePayRequest request) {
        Request<PrePayRequest> internalRequest = new DefaultRequest<PrePayRequest>(request, serviceName);
        ...
        if (request.getUserId() != null) {
            internalRequest.addParameter("userId", PrimitiveMarshallerUtils.marshalling(request.getUserId(), "String"));
        }
        ...
        if (request.getUserAuthCode() != null) {
            internalRequest.addParameter("userAuthCode", PrimitiveMarshallerUtils.marshalling(request.getUserAuthCode(), "String"));
        }
        if (request.getChannelActivityInfo() != null) {
            internalRequest.addParameter("channelActivityInfo", PrimitiveMarshallerUtils.marshalling(request.getChannelActivityInfo(), "String"));
        }
