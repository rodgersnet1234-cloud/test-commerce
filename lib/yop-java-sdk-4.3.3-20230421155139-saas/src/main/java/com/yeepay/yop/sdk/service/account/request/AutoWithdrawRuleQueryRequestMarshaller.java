...
public class AutoWithdrawRuleQueryRequestMarshaller implements RequestMarshaller<AutoWithdrawRuleQueryRequest> {
    private final String serviceName = "Account";

    private final String resourcePath = "/rest/v1.0/account/auto-withdraw-rule/query";
    ...
    @Override
    public Request<AutoWithdrawRuleQueryRequest> marshall(AutoWithdrawRuleQueryRequest request) {
        Request<AutoWithdrawRuleQueryRequest> internalRequest = new DefaultRequest<AutoWithdrawRuleQueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static AutoWithdrawRuleQueryRequestMarshaller INSTANCE = new AutoWithdrawRuleQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static AutoWithdrawRuleQueryRequestMarshaller getInstance() {
