...
public class AgreementPaymentSignRequestMarshaller implements RequestMarshaller<AgreementPaymentSignRequest> {
    private final String serviceName = "MWallet";

    private final String resourcePath = "/rest/v1.0/m-wallet/agreement/payment-sign";
    ...
    @Override
    public Request<AgreementPaymentSignRequest> marshall(AgreementPaymentSignRequest request) {
        Request<AgreementPaymentSignRequest> internalRequest = new DefaultRequest<AgreementPaymentSignRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static AgreementPaymentSignRequestMarshaller INSTANCE = new AgreementPaymentSignRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static AgreementPaymentSignRequestMarshaller getInstance() {
