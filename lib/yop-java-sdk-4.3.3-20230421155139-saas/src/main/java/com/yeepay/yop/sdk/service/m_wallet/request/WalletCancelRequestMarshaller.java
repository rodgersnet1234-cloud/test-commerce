...
public class WalletCancelRequestMarshaller implements RequestMarshaller<WalletCancelRequest> {
    ...
    @Override
    public Request<WalletCancelRequest> marshall(WalletCancelRequest request) {
        Request<WalletCancelRequest> internalRequest = new DefaultRequest<WalletCancelRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static WalletCancelRequestMarshaller INSTANCE = new WalletCancelRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static WalletCancelRequestMarshaller getInstance() {
