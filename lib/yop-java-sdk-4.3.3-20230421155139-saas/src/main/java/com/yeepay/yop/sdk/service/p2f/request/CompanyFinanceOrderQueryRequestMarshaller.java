...
public class CompanyFinanceOrderQueryRequestMarshaller implements RequestMarshaller<CompanyFinanceOrderQueryRequest> {
    private final String serviceName = "P2f";

    private final String resourcePath = "/rest/v1.0/p2f/company-finance/order/query";
    ...
    @Override
    public Request<CompanyFinanceOrderQueryRequest> marshall(CompanyFinanceOrderQueryRequest request) {
        Request<CompanyFinanceOrderQueryRequest> internalRequest = new DefaultRequest<CompanyFinanceOrderQueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static CompanyFinanceOrderQueryRequestMarshaller INSTANCE = new CompanyFinanceOrderQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static CompanyFinanceOrderQueryRequestMarshaller getInstance() {
