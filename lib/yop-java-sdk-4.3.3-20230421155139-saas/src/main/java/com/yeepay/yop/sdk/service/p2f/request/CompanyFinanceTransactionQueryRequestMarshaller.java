...
public class CompanyFinanceTransactionQueryRequestMarshaller implements RequestMarshaller<CompanyFinanceTransactionQueryRequest> {
    private final String serviceName = "P2f";

    private final String resourcePath = "/rest/v1.0/p2f/company-finance/transaction/query";
    ...
    @Override
    public Request<CompanyFinanceTransactionQueryRequest> marshall(CompanyFinanceTransactionQueryRequest request) {
        Request<CompanyFinanceTransactionQueryRequest> internalRequest = new DefaultRequest<CompanyFinanceTransactionQueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static CompanyFinanceTransactionQueryRequestMarshaller INSTANCE = new CompanyFinanceTransactionQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static CompanyFinanceTransactionQueryRequestMarshaller getInstance() {
