...
public class AgreementPaymentQueryRequestMarshaller implements RequestMarshaller<AgreementPaymentQueryRequest> {
    private final String serviceName = "MWallet";

    private final String resourcePath = "/rest/v1.0/m-wallet/agreement/payment-query";
    ...
    @Override
    public Request<AgreementPaymentQueryRequest> marshall(AgreementPaymentQueryRequest request) {
        Request<AgreementPaymentQueryRequest> internalRequest = new DefaultRequest<AgreementPaymentQueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static AgreementPaymentQueryRequestMarshaller INSTANCE = new AgreementPaymentQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static AgreementPaymentQueryRequestMarshaller getInstance() {
