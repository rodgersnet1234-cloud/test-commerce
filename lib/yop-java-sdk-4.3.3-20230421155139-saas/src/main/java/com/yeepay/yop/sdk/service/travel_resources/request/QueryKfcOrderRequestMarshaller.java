...
public class QueryKfcOrderRequestMarshaller implements RequestMarshaller<QueryKfcOrderRequest> {
    private final String serviceName = "TravelResources";

    private final String resourcePath = "/rest/v1.0/travel-resources/query-kfc-order";
    ...
    @Override
    public Request<QueryKfcOrderRequest> marshall(QueryKfcOrderRequest request) {
        Request<QueryKfcOrderRequest> internalRequest = new DefaultRequest<QueryKfcOrderRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static QueryKfcOrderRequestMarshaller INSTANCE = new QueryKfcOrderRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static QueryKfcOrderRequestMarshaller getInstance() {
