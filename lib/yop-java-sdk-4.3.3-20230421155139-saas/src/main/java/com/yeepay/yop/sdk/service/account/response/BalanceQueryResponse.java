...
public class BalanceQueryResponse extends BaseResponse {
    ...
    private BalanceQueryAccountInfoRespDTOResult result;

    public BalanceQueryAccountInfoRespDTOResult getResult() {
        return result;
    }

    public void setResult(BalanceQueryAccountInfoRespDTOResult result) {
        this.result = result;
    }
