...
public class CardQueryRequestMarshaller implements RequestMarshaller<CardQueryRequest> {
    ...
    @Override
    public Request<CardQueryRequest> marshall(CardQueryRequest request) {
        Request<CardQueryRequest> internalRequest = new DefaultRequest<CardQueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static CardQueryRequestMarshaller INSTANCE = new CardQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static CardQueryRequestMarshaller getInstance() {
