...
public class BankAccountQueryWithdrawRequestMarshaller implements RequestMarshaller<BankAccountQueryWithdrawRequest> {
    private final String serviceName = "MWallet";

    private final String resourcePath = "/rest/v1.0/m-wallet/bank-account/query-withdraw";
    ...
    @Override
    public Request<BankAccountQueryWithdrawRequest> marshall(BankAccountQueryWithdrawRequest request) {
        Request<BankAccountQueryWithdrawRequest> internalRequest = new DefaultRequest<BankAccountQueryWithdrawRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static BankAccountQueryWithdrawRequestMarshaller INSTANCE = new BankAccountQueryWithdrawRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static BankAccountQueryWithdrawRequestMarshaller getInstance() {
