...
public class RechargeQueryRequestMarshaller implements RequestMarshaller<RechargeQueryRequest> {
    private final String serviceName = "Account";

    private final String resourcePath = "/rest/v1.0/account/recharge/query";
    ...
    @Override
    public Request<RechargeQueryRequest> marshall(RechargeQueryRequest request) {
        Request<RechargeQueryRequest> internalRequest = new DefaultRequest<RechargeQueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static RechargeQueryRequestMarshaller INSTANCE = new RechargeQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static RechargeQueryRequestMarshaller getInstance() {
