...
public class SettleCardModifyRequestMarshaller implements RequestMarshaller<SettleCardModifyRequest> {
    ...
    @Override
    public Request<SettleCardModifyRequest> marshall(SettleCardModifyRequest request) {
        Request<SettleCardModifyRequest> internalRequest = new DefaultRequest<SettleCardModifyRequest>(request, serviceName);
        ...
        if (request.getBrancgCode() != null) {
            internalRequest.addParameter("brancgCode", PrimitiveMarshallerUtils.marshalling(request.getBrancgCode(), "String"));
        }
    ...
    private static class CacheInstanceHolder {
        public static SettleCardModifyRequestMarshaller INSTANCE = new SettleCardModifyRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static SettleCardModifyRequestMarshaller getInstance() {
