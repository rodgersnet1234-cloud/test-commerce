...
public class RefundRequestMarshaller implements RequestMarshaller<RefundRequest> {
    ...
    @Override
    public Request<RefundRequest> marshall(RefundRequest request) {
        Request<RefundRequest> internalRequest = new DefaultRequest<RefundRequest>(request, serviceName);
        ...
        if (request.getRefundRequestId() != null) {
            internalRequest.addParameter("refundRequestId", PrimitiveMarshallerUtils.marshalling(request.getRefundRequestId(), "String"));
        }
        ...
        if (request.getRefundAmount() != null) {
            internalRequest.addParameter("refundAmount", PrimitiveMarshallerUtils.marshalling(request.getRefundAmount(), "String"));
        }
        if (request.getDescription() != null) {
            internalRequest.addParameter("description", PrimitiveMarshallerUtils.marshalling(request.getDescription(), "String"));
        }
        ...
        if (request.getRefundAccountType() != null) {
            internalRequest.addParameter("refundAccountType", PrimitiveMarshallerUtils.marshalling(request.getRefundAccountType(), "String"));
        }
        ...
        if (request.getYpPromotionRefundInfo() != null) {
            internalRequest.addParameter("ypPromotionRefundInfo", PrimitiveMarshallerUtils.marshalling(request.getYpPromotionRefundInfo(), "String"));
        }
