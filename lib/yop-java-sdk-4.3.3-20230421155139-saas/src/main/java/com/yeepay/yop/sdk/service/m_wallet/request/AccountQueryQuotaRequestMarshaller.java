...
public class AccountQueryQuotaRequestMarshaller implements RequestMarshaller<AccountQueryQuotaRequest> {
    private final String serviceName = "MWallet";

    private final String resourcePath = "/rest/v1.0/m-wallet/account/query-quota";
    ...
    @Override
    public Request<AccountQueryQuotaRequest> marshall(AccountQueryQuotaRequest request) {
        Request<AccountQueryQuotaRequest> internalRequest = new DefaultRequest<AccountQueryQuotaRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static AccountQueryQuotaRequestMarshaller INSTANCE = new AccountQueryQuotaRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static AccountQueryQuotaRequestMarshaller getInstance() {
