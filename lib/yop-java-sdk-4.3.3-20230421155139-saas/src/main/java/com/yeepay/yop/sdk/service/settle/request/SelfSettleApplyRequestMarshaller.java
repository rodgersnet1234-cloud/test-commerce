...
public class SelfSettleApplyRequestMarshaller implements RequestMarshaller<SelfSettleApplyRequest> {
    ...
    public Request<SelfSettleApplyRequest> marshall(SelfSettleApplyRequest request) {
        Request<SelfSettleApplyRequest> internalRequest = new DefaultRequest<SelfSettleApplyRequest>(request, serviceName);
        ...
        if (request.getBankRemark() != null) {
            internalRequest.addParameter("bankRemark", PrimitiveMarshallerUtils.marshalling(request.getBankRemark(), "String"));
        }
