...
public class ReceiptGetRequestMarshaller implements RequestMarshaller<ReceiptGetRequest> {
    private final String serviceName = "Account";

    private final String resourcePath = "/rest/v1.0/account/receipt/get";
    ...
    @Override
    public Request<ReceiptGetRequest> marshall(ReceiptGetRequest request) {
        Request<ReceiptGetRequest> internalRequest = new DefaultRequest<ReceiptGetRequest>(request, serviceName);
        ...
        if (request.getTradeType() != null) {
            internalRequest.addParameter("tradeType", PrimitiveMarshallerUtils.marshalling(request.getTradeType(), "String"));
        }
        if (request.getOrderNo() != null) {
            internalRequest.addParameter("orderNo", PrimitiveMarshallerUtils.marshalling(request.getOrderNo(), "String"));
        }
    ...
    private static class CacheInstanceHolder {
        public static ReceiptGetRequestMarshaller INSTANCE = new ReceiptGetRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static ReceiptGetRequestMarshaller getInstance() {
