...
public class BillDividedaydownloadRequestMarshaller implements RequestMarshaller<BillDividedaydownloadRequest> {
    private final String serviceName = "Std";

    private final String resourcePath = "/yos/v1.0/std/bill/dividedaydownload";
    ...
    @Override
    public Request<BillDividedaydownloadRequest> marshall(BillDividedaydownloadRequest request) {
        Request<BillDividedaydownloadRequest> internalRequest = new DefaultRequest<BillDividedaydownloadRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static BillDividedaydownloadRequestMarshaller INSTANCE = new BillDividedaydownloadRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static BillDividedaydownloadRequestMarshaller getInstance() {
