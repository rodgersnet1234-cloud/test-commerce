...
public class BindcardQueryorderRequestMarshaller implements RequestMarshaller<BindcardQueryorderRequest> {
    private final String serviceName = "Frontcashier";

    private final String resourcePath = "/rest/v1.0/frontcashier/bindcard/queryorder";
    ...
    @Override
    public Request<BindcardQueryorderRequest> marshall(BindcardQueryorderRequest request) {
        Request<BindcardQueryorderRequest> internalRequest = new DefaultRequest<BindcardQueryorderRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static BindcardQueryorderRequestMarshaller INSTANCE = new BindcardQueryorderRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static BindcardQueryorderRequestMarshaller getInstance() {
