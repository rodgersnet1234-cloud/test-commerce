...
public class FacepayProxyConfirmVerifySmscodeRequestMarshaller implements RequestMarshaller<FacepayProxyConfirmVerifySmscodeRequest> {
    private final String serviceName = "Facepay";

    private final String resourcePath = "/rest/v1.0/facepay/facepay-proxy/confirm-verify-smscode";
    ...
    @Override
    public Request<FacepayProxyConfirmVerifySmscodeRequest> marshall(FacepayProxyConfirmVerifySmscodeRequest request) {
        Request<FacepayProxyConfirmVerifySmscodeRequest> internalRequest = new DefaultRequest<FacepayProxyConfirmVerifySmscodeRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static FacepayProxyConfirmVerifySmscodeRequestMarshaller INSTANCE = new FacepayProxyConfirmVerifySmscodeRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static FacepayProxyConfirmVerifySmscodeRequestMarshaller getInstance() {
