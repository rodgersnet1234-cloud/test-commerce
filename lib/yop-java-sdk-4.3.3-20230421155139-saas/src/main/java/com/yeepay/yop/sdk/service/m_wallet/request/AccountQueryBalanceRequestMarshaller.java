...
public class AccountQueryBalanceRequestMarshaller implements RequestMarshaller<AccountQueryBalanceRequest> {
    ...
    public Request<AccountQueryBalanceRequest> marshall(AccountQueryBalanceRequest request) {
        Request<AccountQueryBalanceRequest> internalRequest = new DefaultRequest<AccountQueryBalanceRequest>(request, serviceName);
        ...
        if (request.getElecAccount() != null) {
            internalRequest.addParameter("elecAccount", PrimitiveMarshallerUtils.marshalling(request.getElecAccount(), "String"));
        }
