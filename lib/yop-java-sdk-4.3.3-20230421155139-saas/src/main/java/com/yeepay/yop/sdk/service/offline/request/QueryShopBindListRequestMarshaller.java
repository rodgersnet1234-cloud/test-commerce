...
public class QueryShopBindListRequestMarshaller implements RequestMarshaller<QueryShopBindListRequest> {
    private final String serviceName = "Offline";

    private final String resourcePath = "/rest/v1.0/offline/query-shop-bind-list";
    ...
    @Override
    public Request<QueryShopBindListRequest> marshall(QueryShopBindListRequest request) {
        Request<QueryShopBindListRequest> internalRequest = new DefaultRequest<QueryShopBindListRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static QueryShopBindListRequestMarshaller INSTANCE = new QueryShopBindListRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static QueryShopBindListRequestMarshaller getInstance() {
