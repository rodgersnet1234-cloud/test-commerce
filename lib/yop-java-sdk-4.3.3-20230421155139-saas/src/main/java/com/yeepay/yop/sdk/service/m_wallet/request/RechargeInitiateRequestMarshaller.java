...
public class RechargeInitiateRequestMarshaller implements RequestMarshaller<RechargeInitiateRequest> {
    private final String serviceName = "MWallet";

    private final String resourcePath = "/rest/v1.0/m-wallet/recharge/initiate";
    ...
    @Override
    public Request<RechargeInitiateRequest> marshall(RechargeInitiateRequest request) {
        Request<RechargeInitiateRequest> internalRequest = new DefaultRequest<RechargeInitiateRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static RechargeInitiateRequestMarshaller INSTANCE = new RechargeInitiateRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static RechargeInitiateRequestMarshaller getInstance() {
