...
public class RecordQueryRequestMarshaller implements RequestMarshaller<RecordQueryRequest> {
    private final String serviceName = "Invoice";

    private final String resourcePath = "/rest/v1.0/invoice/record/query";
    ...
    @Override
    public Request<RecordQueryRequest> marshall(RecordQueryRequest request) {
        Request<RecordQueryRequest> internalRequest = new DefaultRequest<RecordQueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static RecordQueryRequestMarshaller INSTANCE = new RecordQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static RecordQueryRequestMarshaller getInstance() {
