...
public class MerchantDisposeUnfreezeRequestMarshaller implements RequestMarshaller<MerchantDisposeUnfreezeRequest> {
    private final String serviceName = "Mer";

    private final String resourcePath = "/rest/v1.0/mer/merchant/dispose/unfreeze";
    ...
    @Override
    public Request<MerchantDisposeUnfreezeRequest> marshall(MerchantDisposeUnfreezeRequest request) {
        Request<MerchantDisposeUnfreezeRequest> internalRequest = new DefaultRequest<MerchantDisposeUnfreezeRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static MerchantDisposeUnfreezeRequestMarshaller INSTANCE = new MerchantDisposeUnfreezeRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static MerchantDisposeUnfreezeRequestMarshaller getInstance() {
