...
public class FacepayProxyQueryOrderBeforeRequestMarshaller implements RequestMarshaller<FacepayProxyQueryOrderBeforeRequest> {
    private final String serviceName = "Facepay";

    private final String resourcePath = "/rest/v1.0/facepay/facepay-proxy/query-order-before";
    ...
    @Override
    public Request<FacepayProxyQueryOrderBeforeRequest> marshall(FacepayProxyQueryOrderBeforeRequest request) {
        Request<FacepayProxyQueryOrderBeforeRequest> internalRequest = new DefaultRequest<FacepayProxyQueryOrderBeforeRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static FacepayProxyQueryOrderBeforeRequestMarshaller INSTANCE = new FacepayProxyQueryOrderBeforeRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static FacepayProxyQueryOrderBeforeRequestMarshaller getInstance() {
