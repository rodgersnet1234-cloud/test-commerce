...
public class AccountFaceCertifyOpenRequestMarshaller implements RequestMarshaller<AccountFaceCertifyOpenRequest> {
    private final String serviceName = "MWallet";

    private final String resourcePath = "/rest/v1.0/m-wallet/account/face-certify-open";
    ...
    @Override
    public Request<AccountFaceCertifyOpenRequest> marshall(AccountFaceCertifyOpenRequest request) {
        Request<AccountFaceCertifyOpenRequest> internalRequest = new DefaultRequest<AccountFaceCertifyOpenRequest>(request, serviceName);
        ...
        if (request.getCertificateType() != null) {
            internalRequest.addParameter("certificateType", PrimitiveMarshallerUtils.marshalling(request.getCertificateType().getValue(), "String"));
        }
    ...
    private static class CacheInstanceHolder {
        public static AccountFaceCertifyOpenRequestMarshaller INSTANCE = new AccountFaceCertifyOpenRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static AccountFaceCertifyOpenRequestMarshaller getInstance() {
