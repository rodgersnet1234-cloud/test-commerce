...
public class TransferB2cMarketRequestMarshaller implements RequestMarshaller<TransferB2cMarketRequest> {
    ...
    @Override
    public Request<TransferB2cMarketRequest> marshall(TransferB2cMarketRequest request) {
        Request<TransferB2cMarketRequest> internalRequest = new DefaultRequest<TransferB2cMarketRequest>(request, serviceName);
