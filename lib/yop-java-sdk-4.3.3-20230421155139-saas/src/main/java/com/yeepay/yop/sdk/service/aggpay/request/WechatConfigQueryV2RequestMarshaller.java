...
public class WechatConfigQueryV2RequestMarshaller implements RequestMarshaller<WechatConfigQueryV2Request> {
    ...
    @Override
    public Request<WechatConfigQueryV2Request> marshall(WechatConfigQueryV2Request request) {
        Request<WechatConfigQueryV2Request> internalRequest = new DefaultRequest<WechatConfigQueryV2Request>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static WechatConfigQueryV2RequestMarshaller INSTANCE = new WechatConfigQueryV2RequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static WechatConfigQueryV2RequestMarshaller getInstance() {
