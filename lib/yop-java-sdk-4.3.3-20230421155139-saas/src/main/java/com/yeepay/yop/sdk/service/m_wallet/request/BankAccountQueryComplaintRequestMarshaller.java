...
public class BankAccountQueryComplaintRequestMarshaller implements RequestMarshaller<BankAccountQueryComplaintRequest> {
    private final String serviceName = "MWallet";

    private final String resourcePath = "/rest/v1.0/m-wallet/bank-account/query-complaint";
    ...
    @Override
    public Request<BankAccountQueryComplaintRequest> marshall(BankAccountQueryComplaintRequest request) {
        Request<BankAccountQueryComplaintRequest> internalRequest = new DefaultRequest<BankAccountQueryComplaintRequest>(request, serviceName);
        ...
        if (request.getBankTradeNo() != null) {
            internalRequest.addParameter("bankTradeNo", PrimitiveMarshallerUtils.marshalling(request.getBankTradeNo(), "String"));
        }
        if (request.getTradeTime() != null) {
            internalRequest.addParameter("tradeTime", PrimitiveMarshallerUtils.marshalling(request.getTradeTime(), "String"));
        }
    ...
    private static class CacheInstanceHolder {
        public static BankAccountQueryComplaintRequestMarshaller INSTANCE = new BankAccountQueryComplaintRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static BankAccountQueryComplaintRequestMarshaller getInstance() {
