...
public class BindcardPayerrequestRequestMarshaller implements RequestMarshaller<BindcardPayerrequestRequest> {
    ...
    @Override
    public Request<BindcardPayerrequestRequest> marshall(BindcardPayerrequestRequest request) {
        Request<BindcardPayerrequestRequest> internalRequest = new DefaultRequest<BindcardPayerrequestRequest>(request, serviceName);
