...
public class EnterpriseAutoPaymentOrderRequestMarshaller implements RequestMarshaller<EnterpriseAutoPaymentOrderRequest> {
    private final String serviceName = "Account";

    private final String resourcePath = "/rest/v1.0/account/enterprise/auto-payment/order";
    ...
    @Override
    public Request<EnterpriseAutoPaymentOrderRequest> marshall(EnterpriseAutoPaymentOrderRequest request) {
        Request<EnterpriseAutoPaymentOrderRequest> internalRequest = new DefaultRequest<EnterpriseAutoPaymentOrderRequest>(request, serviceName);
        ...
        if (request.getPayerNotifyUrl() != null) {
            internalRequest.addParameter("payerNotifyUrl", PrimitiveMarshallerUtils.marshalling(request.getPayerNotifyUrl(), "String"));
        }
    ...
    private static class CacheInstanceHolder {
        public static EnterpriseAutoPaymentOrderRequestMarshaller INSTANCE = new EnterpriseAutoPaymentOrderRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static EnterpriseAutoPaymentOrderRequestMarshaller getInstance() {
