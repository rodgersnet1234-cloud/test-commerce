...
public class EnterpriseAccountPayOrderRequestMarshaller implements RequestMarshaller<EnterpriseAccountPayOrderRequest> {
    private final String serviceName = "Account";

    private final String resourcePath = "/rest/v1.0/account/enterprise/account-pay/order";
    ...
    @Override
    public Request<EnterpriseAccountPayOrderRequest> marshall(EnterpriseAccountPayOrderRequest request) {
        Request<EnterpriseAccountPayOrderRequest> internalRequest = new DefaultRequest<EnterpriseAccountPayOrderRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static EnterpriseAccountPayOrderRequestMarshaller INSTANCE = new EnterpriseAccountPayOrderRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static EnterpriseAccountPayOrderRequestMarshaller getInstance() {
