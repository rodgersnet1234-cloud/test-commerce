...
public class AutoDeductionQueryRequestMarshaller implements RequestMarshaller<AutoDeductionQueryRequest> {
    private final String serviceName = "MWallet";

    private final String resourcePath = "/rest/v1.0/m-wallet/trade/auto-deduction/query";
    ...
    @Override
    public Request<AutoDeductionQueryRequest> marshall(AutoDeductionQueryRequest request) {
        Request<AutoDeductionQueryRequest> internalRequest = new DefaultRequest<AutoDeductionQueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static AutoDeductionQueryRequestMarshaller INSTANCE = new AutoDeductionQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static AutoDeductionQueryRequestMarshaller getInstance() {
