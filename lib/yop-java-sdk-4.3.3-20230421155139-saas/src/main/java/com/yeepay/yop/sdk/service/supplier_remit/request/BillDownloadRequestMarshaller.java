...
public class BillDownloadRequestMarshaller implements RequestMarshaller<BillDownloadRequest> {
    ...
    @Override
    public Request<BillDownloadRequest> marshall(BillDownloadRequest request) {
        Request<BillDownloadRequest> internalRequest = new DefaultRequest<BillDownloadRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static BillDownloadRequestMarshaller INSTANCE = new BillDownloadRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static BillDownloadRequestMarshaller getInstance() {
