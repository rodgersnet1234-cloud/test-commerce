...
public class OperateShopRequestMarshaller implements RequestMarshaller<OperateShopRequest> {
    private final String serviceName = "Offline";

    private final String resourcePath = "/rest/v1.0/offline/operate-shop";
    ...
    @Override
    public Request<OperateShopRequest> marshall(OperateShopRequest request) {
        Request<OperateShopRequest> internalRequest = new DefaultRequest<OperateShopRequest>(request, serviceName);
        ...
        if (request.getShopNo() != null) {
            internalRequest.addParameter("shopNo", PrimitiveMarshallerUtils.marshalling(request.getShopNo(), "String"));
        }
    ...
    private static class CacheInstanceHolder {
        public static OperateShopRequestMarshaller INSTANCE = new OperateShopRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static OperateShopRequestMarshaller getInstance() {
