...
public class RefundFastRequestMarshaller implements RequestMarshaller<RefundFastRequest> {
    ...
    @Override
    public Request<RefundFastRequest> marshall(RefundFastRequest request) {
        Request<RefundFastRequest> internalRequest = new DefaultRequest<RefundFastRequest>(request, serviceName);
        ...
        if (request.getCardInfo() != null) {
            internalRequest.addParameter("cardInfo", PrimitiveMarshallerUtils.marshalling(request.getCardInfo(), "String"));
        }
