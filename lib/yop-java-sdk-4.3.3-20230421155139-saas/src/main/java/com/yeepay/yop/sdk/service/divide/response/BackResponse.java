...
public class BackResponse extends BaseResponse {
    private static final long serialVersionUID = 1L;

    private BackYopDivideBackResDTOResult result;

    public BackYopDivideBackResDTOResult getResult() {
        return result;
    }

    public void setResult(BackYopDivideBackResDTOResult result) {
        this.result = result;
    }
