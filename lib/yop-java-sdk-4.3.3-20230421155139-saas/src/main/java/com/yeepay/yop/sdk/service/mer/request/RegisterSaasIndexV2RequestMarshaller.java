...
public class RegisterSaasIndexV2RequestMarshaller implements RequestMarshaller<RegisterSaasIndexV2Request> {
    ...
    @Override
    public Request<RegisterSaasIndexV2Request> marshall(RegisterSaasIndexV2Request request) {
        Request<RegisterSaasIndexV2Request> internalRequest = new DefaultRequest<RegisterSaasIndexV2Request>(request, serviceName);
