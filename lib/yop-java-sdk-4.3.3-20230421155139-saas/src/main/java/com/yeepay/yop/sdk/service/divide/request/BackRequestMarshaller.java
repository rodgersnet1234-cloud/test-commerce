...
public class BackRequestMarshaller implements RequestMarshaller<BackRequest> {
    private final String serviceName = "Divide";

    private final String resourcePath = "/rest/v1.0/divide/back";
    ...
    @Override
    public Request<BackRequest> marshall(BackRequest request) {
        Request<BackRequest> internalRequest = new DefaultRequest<BackRequest>(request, serviceName);
        ...
        if (request.getDivideBackDetail() != null) {
            internalRequest.addParameter("divideBackDetail", PrimitiveMarshallerUtils.marshalling(request.getDivideBackDetail(), "String"));
        }
    ...
    private static class CacheInstanceHolder {
        public static BackRequestMarshaller INSTANCE = new BackRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static BackRequestMarshaller getInstance() {
