...
public class TransferWechatQueryRequestMarshaller implements RequestMarshaller<TransferWechatQueryRequest> {
    private final String serviceName = "Account";

    private final String resourcePath = "/rest/v1.0/account/transfer/wechat/query";
    ...
    @Override
    public Request<TransferWechatQueryRequest> marshall(TransferWechatQueryRequest request) {
        Request<TransferWechatQueryRequest> internalRequest = new DefaultRequest<TransferWechatQueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static TransferWechatQueryRequestMarshaller INSTANCE = new TransferWechatQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static TransferWechatQueryRequestMarshaller getInstance() {
