...
public class EnterpriseAccountBookPayOrderRequestMarshaller implements RequestMarshaller<EnterpriseAccountBookPayOrderRequest> {
    private final String serviceName = "Account";

    private final String resourcePath = "/rest/v1.0/account/enterprise/account-book-pay/order";
    ...
    @Override
    public Request<EnterpriseAccountBookPayOrderRequest> marshall(EnterpriseAccountBookPayOrderRequest request) {
        Request<EnterpriseAccountBookPayOrderRequest> internalRequest = new DefaultRequest<EnterpriseAccountBookPayOrderRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static EnterpriseAccountBookPayOrderRequestMarshaller INSTANCE = new EnterpriseAccountBookPayOrderRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static EnterpriseAccountBookPayOrderRequestMarshaller getInstance() {
