...
public class BillFundbillDownloadRequestMarshaller implements RequestMarshaller<BillFundbillDownloadRequest> {
    private final String serviceName = "Std";

    private final String resourcePath = "/yos/v1.0/std/bill/fundbill/download";
    ...
    @Override
    public Request<BillFundbillDownloadRequest> marshall(BillFundbillDownloadRequest request) {
        Request<BillFundbillDownloadRequest> internalRequest = new DefaultRequest<BillFundbillDownloadRequest>(request, serviceName);
        ...
        if (request.getFileId() != null) {
            internalRequest.addParameter("fileId", PrimitiveMarshallerUtils.marshalling(request.getFileId(), "String"));
        }
    ...
    private static class CacheInstanceHolder {
        public static BillFundbillDownloadRequestMarshaller INSTANCE = new BillFundbillDownloadRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static BillFundbillDownloadRequestMarshaller getInstance() {
