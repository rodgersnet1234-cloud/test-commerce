...
public class PasswordManageRequestMarshaller implements RequestMarshaller<PasswordManageRequest> {
    private final String serviceName = "MWallet";

    private final String resourcePath = "/rest/v1.0/m-wallet/password/manage";
    ...
    @Override
    public Request<PasswordManageRequest> marshall(PasswordManageRequest request) {
        Request<PasswordManageRequest> internalRequest = new DefaultRequest<PasswordManageRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static PasswordManageRequestMarshaller INSTANCE = new PasswordManageRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static PasswordManageRequestMarshaller getInstance() {
