...
public class BankAccountQueryActivationRequestMarshaller implements RequestMarshaller<BankAccountQueryActivationRequest> {
    private final String serviceName = "MWallet";

    private final String resourcePath = "/rest/v1.0/m-wallet/bank-account/query-activation";
    ...
    @Override
    public Request<BankAccountQueryActivationRequest> marshall(BankAccountQueryActivationRequest request) {
        Request<BankAccountQueryActivationRequest> internalRequest = new DefaultRequest<BankAccountQueryActivationRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static BankAccountQueryActivationRequestMarshaller INSTANCE = new BankAccountQueryActivationRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static BankAccountQueryActivationRequestMarshaller getInstance() {
