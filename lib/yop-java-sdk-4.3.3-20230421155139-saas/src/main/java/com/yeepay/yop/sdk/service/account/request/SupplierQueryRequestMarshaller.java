...
public class SupplierQueryRequestMarshaller implements RequestMarshaller<SupplierQueryRequest> {
    private final String serviceName = "Account";

    private final String resourcePath = "/rest/v1.0/account/supplier/query";
    ...
    @Override
    public Request<SupplierQueryRequest> marshall(SupplierQueryRequest request) {
        Request<SupplierQueryRequest> internalRequest = new DefaultRequest<SupplierQueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static SupplierQueryRequestMarshaller INSTANCE = new SupplierQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static SupplierQueryRequestMarshaller getInstance() {
