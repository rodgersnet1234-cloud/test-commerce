...
public class BillQueryOverviewRequestMarshaller implements RequestMarshaller<BillQueryOverviewRequest> {
    private final String serviceName = "MWallet";

    private final String resourcePath = "/rest/v1.0/m-wallet/bill/query-overview";
    ...
    @Override
    public Request<BillQueryOverviewRequest> marshall(BillQueryOverviewRequest request) {
        Request<BillQueryOverviewRequest> internalRequest = new DefaultRequest<BillQueryOverviewRequest>(request, serviceName);
        ...
        if (request.getStartMonth() != null) {
            internalRequest.addParameter("startMonth", PrimitiveMarshallerUtils.marshalling(request.getStartMonth(), "String"));
        }
        if (request.getEndMonth() != null) {
            internalRequest.addParameter("endMonth", PrimitiveMarshallerUtils.marshalling(request.getEndMonth(), "String"));
        }
    ...
    private static class CacheInstanceHolder {
        public static BillQueryOverviewRequestMarshaller INSTANCE = new BillQueryOverviewRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static BillQueryOverviewRequestMarshaller getInstance() {
