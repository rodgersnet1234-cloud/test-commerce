...
public class BankPaymentOrderRequestMarshaller implements RequestMarshaller<BankPaymentOrderRequest> {
    private final String serviceName = "Account";

    private final String resourcePath = "/rest/v1.0/account/bank/payment/order";
    ...
    @Override
    public Request<BankPaymentOrderRequest> marshall(BankPaymentOrderRequest request) {
        Request<BankPaymentOrderRequest> internalRequest = new DefaultRequest<BankPaymentOrderRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static BankPaymentOrderRequestMarshaller INSTANCE = new BankPaymentOrderRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static BankPaymentOrderRequestMarshaller getInstance() {
