...
public class CompanyFinanceAssetsQueryRequestMarshaller implements RequestMarshaller<CompanyFinanceAssetsQueryRequest> {
    private final String serviceName = "P2f";

    private final String resourcePath = "/rest/v1.0/p2f/company-finance/assets/query";
    ...
    @Override
    public Request<CompanyFinanceAssetsQueryRequest> marshall(CompanyFinanceAssetsQueryRequest request) {
        Request<CompanyFinanceAssetsQueryRequest> internalRequest = new DefaultRequest<CompanyFinanceAssetsQueryRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static CompanyFinanceAssetsQueryRequestMarshaller INSTANCE = new CompanyFinanceAssetsQueryRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static CompanyFinanceAssetsQueryRequestMarshaller getInstance() {
