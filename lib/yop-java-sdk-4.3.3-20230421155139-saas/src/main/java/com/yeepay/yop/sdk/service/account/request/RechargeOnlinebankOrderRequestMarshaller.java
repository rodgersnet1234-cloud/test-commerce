...
public class RechargeOnlinebankOrderRequestMarshaller implements RequestMarshaller<RechargeOnlinebankOrderRequest> {
    private final String serviceName = "Account";

    private final String resourcePath = "/rest/v1.0/account/recharge/onlinebank/order";
    ...
    @Override
    public Request<RechargeOnlinebankOrderRequest> marshall(RechargeOnlinebankOrderRequest request) {
        Request<RechargeOnlinebankOrderRequest> internalRequest = new DefaultRequest<RechargeOnlinebankOrderRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static RechargeOnlinebankOrderRequestMarshaller INSTANCE = new RechargeOnlinebankOrderRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static RechargeOnlinebankOrderRequestMarshaller getInstance() {
