...
public class WithdrawCardBindRequestMarshaller implements RequestMarshaller<WithdrawCardBindRequest> {
    ...
    public Request<WithdrawCardBindRequest> marshall(WithdrawCardBindRequest request) {
        Request<WithdrawCardBindRequest> internalRequest = new DefaultRequest<WithdrawCardBindRequest>(request, serviceName);
