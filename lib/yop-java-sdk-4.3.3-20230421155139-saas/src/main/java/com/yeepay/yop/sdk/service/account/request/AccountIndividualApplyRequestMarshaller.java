...
public class AccountIndividualApplyRequestMarshaller implements RequestMarshaller<AccountIndividualApplyRequest> {
    ...
    public Request<AccountIndividualApplyRequest> marshall(AccountIndividualApplyRequest request) {
        Request<AccountIndividualApplyRequest> internalRequest = new DefaultRequest<AccountIndividualApplyRequest>(request, serviceName);
        ...
        if (request.getFrontUrl() != null) {
            internalRequest.addParameter("frontUrl", PrimitiveMarshallerUtils.marshalling(request.getFrontUrl(), "String"));
        }
        if (request.getContraryUrl() != null) {
            internalRequest.addParameter("contraryUrl", PrimitiveMarshallerUtils.marshalling(request.getContraryUrl(), "String"));
        }
