...
public class RefundReceiptDownloadRequestMarshaller implements RequestMarshaller<RefundReceiptDownloadRequest> {
    private final String serviceName = "Trade";

    private final String resourcePath = "/yos/v1.0/trade/refund/receipt/download";
    ...
    @Override
    public Request<RefundReceiptDownloadRequest> marshall(RefundReceiptDownloadRequest request) {
        Request<RefundReceiptDownloadRequest> internalRequest = new DefaultRequest<RefundReceiptDownloadRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static RefundReceiptDownloadRequestMarshaller INSTANCE = new RefundReceiptDownloadRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static RefundReceiptDownloadRequestMarshaller getInstance() {
