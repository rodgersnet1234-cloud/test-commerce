...
public class SettleWayModifyRatioRequestMarshaller implements RequestMarshaller<SettleWayModifyRatioRequest> {
    private final String serviceName = "Settle";

    private final String resourcePath = "/rest/v1.0/settle/settle-way/modify-ratio";
    ...
    @Override
    public Request<SettleWayModifyRatioRequest> marshall(SettleWayModifyRatioRequest request) {
        Request<SettleWayModifyRatioRequest> internalRequest = new DefaultRequest<SettleWayModifyRatioRequest>(request, serviceName);
    ...
    private static class CacheInstanceHolder {
        public static SettleWayModifyRatioRequestMarshaller INSTANCE = new SettleWayModifyRatioRequestMarshaller();

        private CacheInstanceHolder() {
        }
    }

    public static SettleWayModifyRatioRequestMarshaller getInstance() {
