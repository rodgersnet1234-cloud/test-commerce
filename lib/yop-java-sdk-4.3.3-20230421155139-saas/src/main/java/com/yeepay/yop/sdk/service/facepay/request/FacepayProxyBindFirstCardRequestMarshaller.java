...
public class FacepayProxyBindFirstCardRequestMarshaller implements RequestMarshaller<FacepayProxyBindFirstCardRequest> {
    ...
    public Request<FacepayProxyBindFirstCardRequest> marshall(FacepayProxyBindFirstCardRequest request) {
        Request<FacepayProxyBindFirstCardRequest> internalRequest = new DefaultRequest<FacepayProxyBindFirstCardRequest>(request, serviceName);
