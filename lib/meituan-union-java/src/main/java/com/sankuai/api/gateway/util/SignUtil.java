...
public class SignUtil {
    ...
    private static String buildHeaders(Map<String, String> headers, List<String> signHeaderPrefixList) {
    	...
    	if (null != signHeaderPrefixList) {
    		signHeaderPrefixList.remove(SystemHeader.S_CA_SIGNATURE);
    		signHeaderPrefixList.remove(HttpHeader.HTTP_HEADER_CONTENT_MD5);
            signHeaderPrefixList.remove(SystemHeader.S_CA_SIGNATURE_HEADERS);
    		...
    		if (null != headers) {
    			...
    			headers.put(SystemHeader.S_CA_SIGNATURE_HEADERS, signHeadersStringBuilder.toString());
    		}
    	}
