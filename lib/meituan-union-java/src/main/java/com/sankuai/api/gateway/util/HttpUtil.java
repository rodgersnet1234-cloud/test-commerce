 ...
 * under the License.
 */
package com.sankuai.api.gateway.util;
...
import com.sankuai.api.gateway.constant.SystemHeader;
...
import com.sankuai.api.gateway.constant.HttpMethod;
...
public class HttpUtil {
    ...
    private static Map<String, String> initialBasicHeader(String method, String path,
        ...
        headers.put(SystemHeader.S_CA_APP, appKey);
        headers.put(SystemHeader.S_CA_TIMESTAMP, String.valueOf(new Date().getTime()));
        headers.put(SystemHeader.S_CA_SIGNATURE,
