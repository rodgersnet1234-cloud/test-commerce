package com.mailvor.modules.cart.vo;
 ...
 */
@Data
@ApiModel(value = "MwStoreCartQueryVo对象", description = "购物车表查询参数")
public class MwStoreCartQueryVo implements Serializable {
    ...
    private MwStoreProductQueryVo productInfo;
