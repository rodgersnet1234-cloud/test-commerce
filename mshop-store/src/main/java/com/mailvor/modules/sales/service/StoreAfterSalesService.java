package com.mailvor.modules.sales.service;
...
public interface StoreAfterSalesService extends BaseService<StoreAfterSales> {
     ...
     * @return
     */
    List<MwStoreOrderCartInfoVo> checkOrderDetails(String key);
     ...
     */
    Map<String, Object> queryAll(MwStoreAfterSalesQueryCriteria criteria, Pageable pageable);

    /**
     * 查询所有数据不分页
     * @param criteria 条件参数
     * @return List<MwStoreAfterSalesDto>
     */
    List<StoreAfterSales> queryAll(MwStoreAfterSalesQueryCriteria criteria);
     ...
     * @throws IOException /
     */
    void download(List<MwStoreAfterSalesDto> all, HttpServletResponse response) throws IOException;
}
