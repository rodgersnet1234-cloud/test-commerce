...
import com.mailvor.modules.mp.utils.URLUtils;
...
public class WechatArticleService {
    ...
    /**
     * 发布微信图文
     * @param wxNewsArticleItem mwArticleDto
     * @throws WxErrorException
     */
    public void publish(MwArticleDto wxNewsArticleItem) throws WxErrorException {
